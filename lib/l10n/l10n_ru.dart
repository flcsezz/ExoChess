...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Эти настройки применяются к вашему аккаунту Chessigma и будут использоваться на всех устройствах.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Пожалуйста, обратите внимание, что не все функции старого приложения или веб-сайта в настоящее время доступны, но мы постоянно добавляем новые функции.';
  ...
  String get mobilePuzzleStormFilterNothingToShow =>
      'Нечего показывать, пожалуйста, измените фильтры';
  ...
  String get mobilePuzzleStreakAbortWarning =>
      'Вы потеряете свою текущую серию, и счет будет сохранен.';
  ...
  String get mobileSettingsPickAnImageHelp =>
      'Пользовательский фон работает только в тёмном режиме. Рекомендуется использовать изображение с тёмными оттенками.';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Нарисуйте фигуру пальцами: держите один палец на пустой клетке и двигайте другой палец, чтобы рисовать.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Когда включено, устройство будет вибрировать некоторое время при перемещении или захвате фигуры.';
  ...
  @override
  String get mobileWelcomeToChessigmaApp => 'Добро пожаловать в приложение Chessigma!';
  ...
  String get mobileCustomizeHomeTip =>
      'Подсказка: вы можете добавить больше виджетов на главный экран или удалить те, которые вам не нужны!';
  ...
  String get mobileChallengeCreated =>
      'Вызов создан: вы получите уведомление о начале партии.\\nВы можете получить доступ к нему с главной вкладки.';
  ...
  String get variantAntichessTitle =>
      'Проиграйте все ваши фигуры (или получите пат), чтобы выиграть игру.';
  ...
  String get variantHordeTitle =>
      'Одна сторона имеет большое количество пешек, когда другая имеет стандартный набор фигур.';

  @override
  String get variantRacingKingsTitle =>
      'Проведите своего короля на другою сторону доски, чтобы победить.';

  @override
  String get variantCrazyhouseTitle =>
      'Срубленные фигуры могут быть возвращены на доску вместо хода фигурой.';
  ...
  String get arenaDrawStreakVariants =>
      'Минимальное число ходов в ничейных партиях, за которые начисляются очки, зависит от варианта игры. В таблице ниже перечислены пороговые значения для каждого варианта.';
  ...
  @override
  String get broadcastHowToUseChessigmaBroadcasts => 'Как пользоваться трансляциями Chessigma.';
  ...
  String get broadcastSourceUrlHelp =>
      'URL-адрес, с которого Chessigma будет получать обновление PGN. Он должен быть доступен для получения из Интернета.';

  @override
  String get broadcastSourceGameIds =>
      'До 64 идентификаторов (ID) игр Chessigma, разделённых пробелами.';
  ...
  @override
  String get broadcastOpenChessigma => 'Открыть в Chessigma';
  ...
  String get broadcastStandingsDisclaimer =>
      'Турнирная таблица рассчитывается по транслируемым партиям и может отличаться от официальных результатов.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Сохранение названия по умолчанию автоматически переведёт его на все другие языки.';
  ...
  @override
  String get challengeInviteChessigmaUser => 'Или пригласите пользователя Chessigma:';

  @override
  String get contactContact => 'Обратная связь';

  @override
  String get contactContactChessigma => 'Связаться с Chessigma';
  ...
  String get coordinatesMostChessCourses =>
      'В большинстве шахматных курсов и упражнений широко используется шахматная нотация.';

  @override
  String get coordinatesTalkToYourChessFriends =>
      'Вам будет проще общаться с другом-шахматистом, если вы оба будете понимать «язык шахмат».';

  @override
  String get coordinatesYouCanAnalyseAGameMoreEffectively =>
      'Анализировать игры гораздо проще, когда не тратится время на поиск полей по их координатам.';
  ...
  String get coordinatesASquareIsHighlightedExplanation =>
      'Поле подсвечивается на доске, и вам нужно ввести его координаты (например, «e4»).';

  @override
  String get coordinatesYouHaveThirtySeconds =>
      'У вас есть 30 секунд на то, чтобы правильно отметить как можно больше полей!';

  @override
  String get coordinatesGoAsLongAsYouWant =>
      'Продвиньтесь так далеко, как сможете. Время не ограничено!';
  ...
  String get coordinatesPracticeOnlySomeFilesAndRanks =>
      'Потренироваться только с некоторыми вертикалями и горизонталями';

  @override
  String get patronDonate => 'Поддержать проект';

  @override
  String get patronChessigmaPatron => 'Chessigma-спонсор';

  @override
  String get patronBecomePatron => 'Стать спонсором Chessigma';
  ...
  String get preferencesNotifyPush =>
      'Оповещение на устройстве, когда вы не находитесь на сайте Chessigma';
  ...
  String get puzzleThemeBalestraMateDescription =>
      'Слон ставит мат, а ферзь перекрывает оставшиеся поля отступления';
  ...
  String get puzzleThemeBlindSwineMateDescription =>
      'Две ладьи объединяются, чтобы поставить мат королю на поле размером 2 на 2 клетки.';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      'Две противоположные фигуры видят друг друга, и одна передвигается по линии боя, не снимая фигуру противника.';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Загоните короля в угол ладьёй или ферзём, и поставьте там мат конём.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'Переместите фигуру и поставьте шах скрытой до этого атакующей фигурой, чтобы получить решающее преимущество.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Две соседние клетки для спасения короля, оказавшегося под шахом, заняты другими фигурами.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'Ладья ставит мат, в то время как слон контролирует угловое поле.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Слон ставит мат, в то время как ладья контролирует соседнюю вертикаль.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Матовая конструкция, напоминающая собой хвост ласточки; также напоминает букву \"V\".';
  ...
  String get settingsManagedAccountCannotBeClosed =>
      'В вашем аккаунте происходят изменения, и он не может быть удалён.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Постоянная ссылка на игру с заданными настройками.';
  ...
  String get threadsDescription =>
      'Установите количество не больше числа потоков процессора, лучше на предлагаемой отметке';

  @override
  String get threadsDescriptionMobile =>
      'Больше потоков быстрее расходует заряд батареи, но лучше для анализа';
  ...
  String get signupEmailPromise =>
      'Мы будем только отправлять вам письма, касающиеся вашей учётной записи, и никогда не передадим ваш адрес кому-либо.';
  ...
  String get blankedPassword =>
      'Вы использовали такой же пароль на другом сайте, а тот сайт был скомпрометирован. Теперь для безопасности вашей учётной записи на Chessigma необходимо установить новый пароль. Спасибо за ваше понимание.';

  @override
  String get youAreLeavingChessigma => 'Вы покидаете Chessigma';

  @override
  String get neverTypeYourPassword => 'Никогда не вводите свой пароль Chessigma на другом сайте!';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      'Рейтинговые фильтры заблокированы, поскольку ваш рейтинг нестабилен. Играя в рейтинговые игры, вы повысите стабильность вашего рейтинга.';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Ранее на Chessigma TV';
  ...
  @override
  String get lichessTournaments => 'Турниры Chessigma';
  ...
  String get tournamentHomeDescription =>
      'Играйте в быстрые шахматы на турнире! Выбирайте любой из официальных турниров Chessigma или создайте свой собственный. Пуля, блиц, классика, шахматы Фишера, король в центре, три шаха и другие варианты игры обеспечат вам бесконечное шахматное удовольствие!';
  ...
  @override
  String get timeToProcessAMoveOnChessigmaServer => 'Время обработки хода на сервере';
  ...
  String get primaryColorArrowsHowTo =>
      'Ctrl или Shif = красный; Command, Alt, или meta = синий; каждая вышеперечисленная = желтый.';
  ...
  @override
  String get showUnreadChessigmaMessage => 'Вы получили личное сообщение от Chessigma.';
  ...
  @override
  String get agreementPolicy => 'Подтверждаю, что я буду следовать всем правилам Chessigma.';
  ...
  String get lostAgainstTOSViolator =>
      'Вы проиграли тому, кто нарушил пользовательское соглашение Chessigma';
  ...
  @override
  String get lichessDbExplanation => 'Рейтинговые игры по всем игрокам Chessigma';
  ...
  @override
  String get streamerChessigmaStreamers => 'Стримеры Chessigma';
  ...
  @override
  String get studyWelcomeToChessigmaStudyTitle => 'Добро пожаловать в Студии Chessigma!';
  ...
  @override
  String get studyLoadExistingChessigmaGameTitle => 'Загрузите существующую партию Chessigma';

  @override
  String get studyLoadExistingChessigmaGameText =>
      'Вставьте URL игры Chessigma<br>(например, lichess.org/7fHIU0XI)<br>для загрузки ходов партии в главу.';
  ...
  String get studyVariantsAreSupportedText =>
      'Да, вы можете исследовать Безумные шахматы<br>и другие варианты шахмат Chessigma!';
