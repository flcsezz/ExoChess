...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Các tùy chọn này được áp dụng cho tài khoản Chessigma của bạn và sẽ được sử dụng trên tất cả các thiết bị.';
  ...
  String get broadcastSourceUrlHelp =>
      'URL mà Chessigma sẽ khảo sát để nhận cập nhật PGN. Nó phải được truy cập công khai từ Internet.';

  @override
  String get broadcastSourceGameIds =>
      'Tối đa 64 ID ván cờ trên Chessigma, phân tách bằng dấu cách.';
  ...
  String get preferencesExplainShowPlayerRatings =>
      'Điều này sẽ ẩn toàn bộ hệ số khỏi Chessigma để giúp tập trung vào ván cờ. Ván đấu có xếp hạng vẫn ảnh hưởng đến hệ số của bạn, đây chỉ là những gì bạn có thể nhìn thấy.';
  ...
  String get preferencesNotifyPush =>
      'Thông báo tới thiết bị của bạn khi bạn không truy cập Chessigma';
  ...
  String get blankedPassword =>
      'Bạn đã sử dụng cùng một mật khẩu trên một trang web khác và trang web đó đã bị xâm nhập. Để đảm bảo an toàn cho tài khoản Chessigma của bạn, chúng tôi cần bạn đặt mật khẩu mới. Cảm ơn vì bạn đã thông cảm.';
  ...
  String get neverTypeYourPassword =>
      'Không bao giờ nhập mật khẩu Chessigma của bạn trên bất kì trang web nào khác!';
  ...
  String get timeToProcessAMoveOnChessigmaServer =>
      'Thời gian để tiến hành một nước đi trên máy chủ Chessigma';
  ...
  String get agreementPolicy =>
      'Tôi đồng ý rằng, tôi sẽ luôn tuân thủ các chính sách của Chessigma.';
  ...
  String get lostAgainstTOSViolator =>
      'Bạn đã mất điểm hệ số vào người vi phạm Điều khoản Dịch vụ của Chessigma';
  ...
  String get lichessDbExplanation =>
      'Các ván đấu có xếp hạng được lấy từ tất cả các kỳ thủ trên Chessigma';
  ...
  String get studyYouCanPasteThisInTheForumToEmbed =>
      'Bạn có thể dán cái này để nhúng vào diễn đàn hoặc blog Chessigma cá nhân của bạn';
  ...
  String get studyVariantsAreSupportedText =>
      'Có, bạn có thể nghiên cứu Crazyhouse<br>và tất cả các biến thể của Chessigma!';
