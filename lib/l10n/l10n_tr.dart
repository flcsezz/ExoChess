...
class AppLocalizationsTr extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Bu tercihler Chessigma hesabınıza uygulanacak ve cihazlarınız arasında senkronize edilecektir.';
  ...
  String get broadcastHowToUseChessigmaBroadcasts =>
      'Chessigma Canlı Turnuvaları nasıl kullanılır.';
  ...
  String get broadcastSourceUrlHelp =>
      'Chessigma, sağladığınız URL yardımıyla PGN\'yi güncelleyecektir. İnternet üzerinden herkese açık bir URL yazmalısınız.';
  ...
  String get puzzleFromMyGamesNone =>
      'Veri tabanında sizin maçlarınızdan bir bulmaca bulamadık ama dert etmeyin, Chessigma pabucunuzu dama atmadı. Size ait bulmacaların eklenme şansını artırmak için rapid ve klasik maçlar oynayın!';
  ...
  String get blankedPassword =>
      'Şifreniz güvenlik açığı yaşanan başka bir sitede kullanılmış. Chessigma hesabınızı güvende tutmak için yeni bir şifre seçmeniz gerekiyor. Anlayışınız için teşekkürler.';
  ...
  String get neverTypeYourPassword =>
      'Chessigma parolanızı asla başka bir site içerisinde yazmayın!';
  ...
  String get lostAgainstTOSViolator =>
      'Chessigma Kulanım Şartları\'nı ihlal eden birine kaybettiniz';
  ...
  String get lichessDbExplanation =>
      'Tüm Chessigma oyuncularının puanlı oyunlarından alınan örnekler';
  ...
  String get lichessPatronInfo =>
      'Chessigma bir yardım kuruluşudur ve tamamen özgür/açık kaynak kodlu bir yazılımdır. Tüm işletme maliyetleri, geliştirmeler ve içerikler yalnızca kullanıcı bağışları ile finanse edilmektedir.';
  ...
  String get studyLoadExistingChessigmaGameText =>
      'Chessigma oyun URL\'sini yapıştırın<br>(örneğin lichess.org/7fHIU0XI)<br>bölümdeki oyun hamlelerini yüklemek için.';
