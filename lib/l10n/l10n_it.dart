...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Queste preferenze sono applicate al tuo account Chessigma e saranno utilizzate su tutti i dispositivi.';
  ...
  String get variantCrazyhouseTitle =>
      'I pezzi catturati possono essere riemssi sulla scacchiera invece di spostare un pezzo.';
  ...
  String get broadcastSourceUrlHelp =>
      'L\'URL che Chessigma utilizzerà per ottenere gli aggiornamenti dei PGN. Deve essere accessibile pubblicamente su Internet.';
  ...
  String get preferencesNotifyPush =>
      'Notifiche dispositivo (push) quando non sei collegato a Chessigma';
  ...
  String get puzzleFromMyGamesNone =>
      'Nel database dei problemi di Chessigma non è presente nessuna delle tue partite, ma Chessigma ti vuole bene lo stesso.\nGioca altre partite rapide o classiche per aumentare le possibilità di avere un problema tratto dalle tue partite!';
  ...
  String get blankedPassword =>
      'Hai usato la stessa password su un altro sito e quel sito è stato violato. Per garantire la sicurezza del tuo account Chessigma, abbiamo bisogno che imposti una nuova password. Grazie per la tua comprensione.';
  ...
  String get neverTypeYourPassword =>
      'Non digitare mai la tua password di Chessigma su un altro sito!';
  ...
  String get thisAccountViolatedTos =>
      'Questo account ha violato i termini di servizio di Chessigma';
  ...
  String get timeToProcessAMoveOnChessigmaServer =>
      'Tempo per elaborare una mossa sul server di Chessigma';
