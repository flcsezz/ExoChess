...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Ці налаштування застосовуються до вашого облікового запису Chessigma і будуть використовуватися на всіх пристроях.';
  ...
  String get broadcastSourceUrlHelp =>
      'Посилання, яке Chessigma перевірятиме, щоб отримати оновлення PGN. Воно має бути загальнодоступним в Інтернеті.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Постійне посилання, за яким хто-небудь може кинути вам виклик із цими налаштуваннями.';
  ...
  String get blankedPassword =>
      'Ви використали той самий пароль на іншому сайті, безпека якого є під загрозою. Для забезпечення безпеки вашого профілю Chessigma вам потрібно встановити новий пароль. Дякуємо за розуміння.';
  ...
  String get studyLoadExistingChessigmaGameText =>
      'Вставте URL партії Chessigma<br>(наприклад, lichess.org/7fHIU0XI)<br>для завантаження гри в розділ.';
  ...
  String get studyVariantsAreSupportedText =>
      'Так, Ви можете вивчати Crazyhouse<br>та усі інші режими Chessigma!';
