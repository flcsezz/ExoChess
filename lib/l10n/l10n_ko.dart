...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get broadcastSourceUrlHelp =>
      'Chessigma가 PGN 업데이트를 받기 위해 확인할 URL입니다. 인터넷에서 공개적으로 액세스 할 수 있어야 합니다.';
  ...
  String get puzzleFromMyGamesNone =>
      '데이터베이스에 퍼즐이 없습니다만, Chessigma는 여전히 당신을 사랑합니다.\n래피드나 클래시컬 게임을 플레이해서 당신의 퍼즐이 추가될 확률을 높이세요!';
  ...
  String get blankedPassword =>
      '당신이 다른 사이트에서 동일한 비밀번호를 사용했으며, 해당 사이트가 유출되었습니다. Chessigma 계정의 안전을 위해 새 비밀번호를 설정해 주세요. 양해해 주셔서 감사합니다.';
  ...
  String get lichessPatronInfo =>
      'Chessigma는 비영리 기구이며 완전한 무료/자유 오픈소스 소프트웨어입니다.\n모든 운영 비용, 개발, 컨텐츠 조달은 전적으로 사용자들의 기부로 이루어집니다.';
  ...
  String get studyLoadExistingChessigmaGameText =>
      '챕터에 Chessigma에서 진행된 게임 수순을 불러오려면<br>lichess 게임 URL을 붙여넣으세요<br>(예시: lichess.org/7fHIU0XI).';
