...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Ces préférences sont appliquées à votre compte Chessigma et seront utilisées sur tous les appareils.';
  ...
  String get variantAntichessTitle =>
      'Si vous perdez toutes vos pièces (ou êtes en pat), vous gagner la partie.';
  ...
  String get variantRacingKingsTitle =>
      'Amenez votre roi de l\'autre côté de l\'échiquer pour gagner la partie.';
  ...
  String get broadcastHowToUseChessigmaBroadcasts =>
      'Comment utiliser les diffusions dans Chessigma.';
  ...
  String get broadcastSourceUrlHelp =>
      'URL que Chessigma interrogera pour obtenir les mises à jour du PGN. Elle doit être accessible publiquement depuis Internet.';

  @override
  String get broadcastSourceGameIds =>
      'Jusqu\'à 64 ID de partie Chessigma séparés par des espaces.';
  ...
  String get preferencesNotifyPush =>
      'Notification sur votre appareil quand vous n\'êtes pas sur Chessigma';
  ...
  String get blankedPassword =>
      'Vous avez utilisé le même mot de passe sur un autre site, et ce site a été compromis. Pour assurer la sécurité de votre compte Chessigma, vous devez établir un nouveau mot de passe. Merci de votre compréhension.';
  ...
  String get neverTypeYourPassword =>
      'N\'utilisez jamais votre mot de passe Chessigma sur un autre site !';
  ...
  String get thisAccountViolatedTos =>
      'Ce compte a enfreint les conditions d\'utilisation de Chessigma';
  ...
  String get lostAgainstTOSViolator =>
      'Vous avez perdu contre quelqu\'un qui a violé les conditions d’usage de Chessigma';
  ...
  String get lichessDbExplanation =>
      'Échantillon de parties classées jouées par les joueurs de Chessigma';
  ...
  String get studyLoadExistingChessigmaGameText =>
      'Collez l\'URL d\'une partie Chessigma<br>(ex. lichess.org/7fHIU0XI)<br>pour insérer les coups de la partie dans le chapitre.';
  ...
  String get studyVariantsAreSupportedText =>
      'Oui, vous pouvez étudier la variante Crazyhorse<br>et toutes les autres variantes Chessigma!';
