...
class AppLocalizationsSq extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Këto parapëlqime aplikohen te llogaria juaj Chessigma dhe do të përdoren në krejt pajisjet.';
  ...
  String get broadcastSourceUrlHelp =>
      'URL-ja që do të kontrollojë Chessigma-i për të marrë përditësime PGN-sh. Duhet të jetë e përdorshme publikisht që nga Interneti.';
  ...
  String get blankedPassword =>
      'Keni përdorur të njëjtin fjalëkalim si në një sajt tjetër dhe ai sajt është komprometuar. Për të garantuar sigurinë e llogarisë tuaj Chessigma, na duhet t’ju caktojmë një fjalëkalim të ri. Faleminderit për mirëkuptimin.';
  ...
  String get neverTypeYourPassword =>
      'Mos shtypni kurrë fjalëkalimin tuaj për në Chessigma te një sajt tjetër!';
  ...
  String get timeToProcessAMoveOnChessigmaServer =>
      'Kohë për përpunimin e një lëvizje në shërbyesin e Chessigma-it';
  ...
  String get lostAgainstTOSViolator =>
      'Humbët ndaj dikujt që shkeli Kushtet e Shërbimit të Chessigma-it';
  ...
  String get studyYouCanPasteThisInTheForumToEmbed =>
      'Këtë mund ta ngjitni te forumi ose blogu juaj Chessigma, për ta trupëzuar';
