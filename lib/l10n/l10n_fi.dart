...
class AppLocalizationsFi extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Nämä asetukset tallentuvat Chessigma-tunnukseesi ja tulevat käyttöön kaikilla laitteilla.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Ota huomioon, että kaikkia vanhan sovelluksemme tai nettisivumme toimintoja ei tällä hetkellä ole vielä käytettävissä, mutta lisäämme toimintoja koko ajan.';
  ...
  String get mobileSettingsPickAnImageHelp =>
      'Mukautettu taustakuva toimii vain tummassa tilassa. Tumma kuva on suositeltava.';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Piirrä muotoja kahta sormea käyttäen: muoto piirretään pitämällä yhtä sormea tyhjällä ruudulla ja raahamalla toista sormea.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Kun käytössä, laite värähtelee hieman kun siirrät tai lyöt nappulan.';
  ...
  @override
  String get mobileWelcomeToChessigmaApp => 'Tervetuloa Chessigma-sovellukseen!';
  ...
  String get mobileCustomizeHomeTip =>
      'Vinkki: Voit lisätä etusivullesi lisää pienohjelmia tai poistaa ne, joita et tarvitse!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Avausselain ei ole käytettävissä offline-tilassa.';

  @override
  String get mobileChallengeCreated =>
      'Haaste esitetty. Saat ilmoituksen, kun peli alkaa.\\nNäet sen etusivulla.';
  ...
  String get variantAntichessTitle =>
      'Voita peli menettämällä kaikki nappulasi (tai pääsemällä pattiin).';
  ...
  String get variantHordeTitle =>
      'Yhdellä pelaajalla on suuri määrä sotilaita, toisella on normaali armeija.';
  ...
  String get variantCrazyhouseTitle =>
      'Lyödyn nappulan pudottaminen takaisin laudalle on siirto yhtä lailla kuin nappulan siirtäminenkin.';
  ...
  String get arenaSomeRated =>
      'Jotkut turnaukset ovat rankattuja ja siten vaikuttavat vahvuuslukuusi.';
  ...
  String get arenaHowIsTheWinnerDecidedAnswer =>
      'Pelaaja(t) jo(i)lla on eniten pisteitä turnausajan päättyessä julistetaan voittajaksi tai voittajiksi.';
  ...
  String get arenaHowDoesItEndAnswer =>
      'Turnauksella on kohti nollaa juokseva ajastin. Kun se menee nollaan, turnauksen sijoitukset virallistetaan ja voittaja julistetaan. Käynnissä olevat pelit tulee pelata loppuun, mutta ne eivät vaikuta sijoituksiin turnauksessa.';
  ...
  String get arenaThereIsACountdown =>
      'Ensimmäiselle siirrolle on lähtölaskenta. Jos ei tee siirtoa sinä aikana, peli tuomitaan vastustajan hyväksi.';
  ...
  String get arenaDrawStreakVariants =>
      'Kullakin variantilla on pelin vaadittava vähimmäispituus, jolla tasapeliin päättyneistä peleistä saa pisteitä. Alla olevassa taulukossa luetellaan kunkin variantin tasapeliraja.';
  ...
  String get arenaCustomStartDateHelp =>
      'Omalla aikavyöhykkeelläsi. Tämä korvaa asetuksen \"Aika ennen turnauksen alkua\"';
  ...
  String get arenaAllowBerserkHelp =>
      'Anna pelaajien puolittaa aika kellossaan ja tavoitella lisäpistettä';
  ...
  String get arenaArenaStreaksHelp =>
      'Kahden voiton jälkeen jokaisesta seuraavasta voitosta saa 4 pistettä (2 pisteen sijaan).';
  ...
  String get arenaTournamentPairingsAreNowClosed =>
      'Turnauksen peliparien määritys on nyt päättynyt.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Jos peli päättyy tasan ensimmäisten $count siirron aikana, kumpikaan pelaaja ei saa pisteitä.',
      one:
          'Jos peli päättyy tasan ensimmäisen $count siirron aikana, kumpikaan pelaaja ei saa pisteitä.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get broadcastHowToUseChessigmaBroadcasts => 'Kuinka Chessigma-lähetyksiä käytetään.';
  ...
  String get broadcastSourceUrlHelp =>
      'URL, josta Chessigma hakee PGN-päivitykset. Sen täytyy olla julkisesti saatavilla internetissä.';

  @override
  String get broadcastSourceGameIds =>
      'Korkeintaan 64 Chessigma-pelin tunnistenumeroa välilyönneillä eroteltuna.';
  ...
  @override
  String get broadcastOpenChessigma => 'Avaa Chessigmaissä';
  ...
  String get broadcastStandingsDisclaimer =>
      'Sijoitukset lasketaan lähetettyjen pelien perusteella ja voivat poiketa virallisista tuloksista.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Jos säilytät oletusnimen, se käännetään automaattisesti kaikille muille kielille.';
  ...
  @override
  String get challengeInviteChessigmaUser => 'Tai kutsu Chessigma-käyttäjä:';

  @override
  String get contactContact => 'Ota yhteyttä';

  @override
  String get contactContactChessigma => 'Ota yhteyttä Chessigmaiin';
  ...
  @override
  String get patronChessigmaPatron => 'Chessigmain tukija';

  @override
  String get patronBecomePatron => 'Ryhdy Chessigmain tukijaksi';
  ...
  @override
  String get preferencesNotifyBell => 'Kilahtava ilmoitus Chessigmaissä';

  @override
  String get preferencesNotifyPush => 'Laitteen ilmoitus, kun et ole Chessigmaissä';
  ...
  String get puzzleThemeBalestraMateDescription =>
      'Lähetti tekee matin daamin viedessä kuninkaalta muut pakoruudut';
  ...
  String get puzzleThemeBlindSwineMateDescription =>
      'Kaksi tornia matittavat kuninkaan 2x2 ruudun suuruiselle alueelle.';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      'Kaksi eriväristä nappulaa ovat hyökkäyssuunnissaan kohdakkain, ja toinen niistä siirtyy tätä hyökkäyssuuntaa pitkin lyömättä kuitenkaan vastustajan nappulaa.';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Kahlitse kuningas laudan nurkkaan tornilla tai daamilla ja tee sitten matti ratsulla.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'Paljasta yhtä nappulaa siirtämällä toisen hyökkäävän nappulasi shakkaus, millä usein saavuttaa ratkaisevan edun.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Kahdessa ruudussa shakatun kuninkaan molemmin puolin on kussakin pakoruudun vievä nappula.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'Torni matittaa kuninkaan samalla kun lähetti vie kuninkaalta pakoruudut.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Matita vastustajan kuningas lähetilläsi samalla kun torni vie kuninkaalta pakoruudut.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Mattikuvio, jonka V-muoto muistuttaa pääskyn pyrstön muotoa.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Matita vastustajan kuningas tornilla lähetin suojellessa tornia.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Pysyvä linkki, jonka kautta kuka tahansa voi haastaa sinut juuri näillä asetuksilla.';
  ...
  String get maybeIncludeMoreGamesFromThePreferencesMenu =>
      'Ehkä voisit tuoda tähän asetusvalikon kautta lisää pelejä näkyville?';
  ...
  String get multipleLinesDescription =>
      'Aseta analyysirivien sekä laudalla näytettävien siirtonuolien määrä';
  ...
  String get threadsDescription =>
      'Aseta tähän prosessorisi säikeiden määrää pienempi luku, rastit osoittavat hyvän ja turvallisen valinnan';

  @override
  String get threadsDescriptionMobile =>
      'Mitä enemmän säikeitä, sitä enemmän akku kuluu analyysin parantamiseksi';
  ...
  String get signupEmailPromise =>
      'Lähetämme sinulle vain käyttäjätunnustasi koskevia sähköposteja emmekä koskaan jaa sähköpostiosoitettasi muille.';
  ...
  String get blankedPassword =>
      'Olet käyttänyt samaa salasanaa toisella sivustolla, ja kyseinen sivusto on vaarantunut. Sinun on asetettava uusi salasana Chessigma-tunnuksesi turvallisuuden varmistamiseksi. Kiitokset ymmärtäväisyydestäsi.';

  @override
  String get youAreLeavingChessigma => 'Olet poistumassa Chessigmaistä';

  @override
  String get neverTypeYourPassword =>
      'Älä koskaan kirjoita Chessigma-salasanaasi toiselle sivustolle!';
  ...
  @override
  String get thisAccountViolatedTos => 'Tämä käyttäjätunnus rikkoi Chessigmain käyttöehtoja';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      'Vahvuuslukusuodatin ei ole käytettävissäsi, koska vahvuuslukusi ei ole vakaa. Voit vakauttaa sitä pelaamalla pisteytettyjä pelejä.';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Viimeksi Chessigma TV:ssä';
  ...
  String get signUpToHostOrJoinASimul =>
      'Kirjaudu sisään, jotta voit pitää simultaanin tai liittyä simultaaniin';
  ...
  String get aboutSimulSettings =>
      'Simultaanit ovat aina rentoja. Revanssit, siirtojen perumiset ja ajan lisääminen ovat poissa käytöstä.';
  ...
  @override
  String get lichessTournaments => 'Chessigmain turnaukset';
  ...
  String byRegisteringYouAgreeToBeBoundByOur(String param) {
    return 'Rekisteröitymällä hyväksyt Chessigmain $param ja sitoudut noudattamaan niitä.';
  }
  ...
  @override
  String get networkLagBetweenYouAndChessigma => 'Verkkoviive sinun ja lichessin välillä';

  @override
  String get timeToProcessAMoveOnChessigmaServer => 'Palvelimen siirtojen käsittelyyn vaatima aika';
  ...
  String get primaryColorArrowsHowTo =>
      'Ctrl tai Shift = punainen; Command, Alt tai Meta = sininen; näppäinyhdistelmä (yksi näppäin kustakin ryhmästä edellä) = keltainen.';
  ...
  String inKidModeTheChessigmaLogoGetsIconX(String param) {
    return 'Lapsitilassa Chessigmain logoon liitetään $param-kuvake, josta tiedät lastesi olevan turvassa.';
  }
  ...
  @override
  String get showUnreadChessigmaMessage => 'Olet saanut henkilökohtaisen viestin Chessigmailtä.';
  ...
  @override
  String get agreementPolicy => 'Vakuutan että noudatan Chessigmain sääntöjä.';
  ...
  String get lostAgainstTOSViolator =>
      'Olet hävinnyt Chessigmain käyttöehtoja rikkoneelle henkilölle';
  ...
  @override
  String get lichessDbExplanation => 'Chessigmain kaikkien pelaajien pisteytetyt pelit';
  ...
  @override
  String get streamerChessigmaStreamers => 'Chessigma-striimaajat';
  ...
  @override
  String get studyWelcomeToChessigmaStudyTitle => 'Tervetuloa Chessigma-tutkielmiin!';

  @override
  String get studyWelcomeToChessigmaStudyText =>
      'Tämä on jaettu analyysilauta.<br><br>Käytä sitä pelien analysoimiseen ja kommentoimiseen,<br>asemien tarkasteluun ystävien kesken<br>ja tietysti shakkioppitunneilla!<br><br>Katsotaanpa lähemmin, miten tämä tehokas työkalu toimii.';
  ...
  String get studySharedAndSavedText =>
      'Toiset jäsenet näkevät siirtosi reaaliajassa!<br>Lisäksi kaikki pysyy ikuisesti tallennettuna.';
  ...
  String get studyStudyChaptersText =>
      'Tutkielma voi sisältää useita lukuja.<br>Jokaisella luvulla on oma alkuasemansa ja siirtopuukaavionsa.';
  ...
  String get studyAnnotatePositionText =>
      'Napsauta !?-painiketta tai hiiren oikealla näppäimellä oikealla olevaa siirtolistaa.<br>Arviosymbolit tallentuvat ja tulevat näkyviin kaikille jäsenille.';
  ...
  String get studyCreateChapterText =>
      'Tutkielmassa voi olla useita lukuja.<br>Jokaisella luvulla on oma siirtopuukaavionsa,<br>ja lukuja voidaan luoda monin eri tavoin.';
  ...
  String get studyFromInitialPositionText =>
      'Lauta on alkuasemassa valmiina uuteen peliin.<br>Tämä sopii avausten tutkimiseen.';
  ...
  String get studyCustomPositionText =>
      'Aseta nappulat laudalle haluamallasi tavalla.<br>Tämä sopii loppupelien tutkimiseen.';

  @override
  String get studyLoadExistingChessigmaGameTitle => 'Lataa Chessigmaissä pelattu peli';

  @override
  String get studyLoadExistingChessigmaGameText =>
      'Kun liität Chessigmaissä pelatun pelin URL:n<br>(esim. lichess.org/7fHIU0XI)<br>pelin siirrot latautuvat tutkielman lukuun.';
  ...
  String get studyFromFenStringText =>
      'Kun liität aseman FEN-muodossa,<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>tutkielman luku alkaa kyseisestä asemasta.';
  ...
  String get studyFromPgnGameText =>
      'Kun liität pelin PGN-muodossa,<br>sen siirrot, kommentit ja muunnelmat latautuvat tutkielman lukuun.';
  ...
  String get studyVariantsAreSupportedText =>
      'Kyllä, voit tutkia crazyhousea<br>ja kaikkia Chessigmain variantteja!';
