...
class AppLocalizationsBe extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Гэтыя налады звязаны з уліковым запісам Chessigma і будуць выкарыстаны на ўсіх дэвайсах.';
  ...
  String get mobileMustBeLoggedIn =>
      'Вам патрэбна ўвайсці ў уліковы запіс каб паглядзець гэтую старонку.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Калі ласка звярніце ўвагу, што не ўсе функцыі з старога дадатку або вэб-сайту на дадзены момант даступныя, але мы дадаем іх увесь час.';
  ...
  String get mobilePuzzleStormFilterNothingToShow =>
      'Няма што паказаць, калі ласка змяніце фільтры';
  ...
  String get mobilePuzzleStreakAbortWarning =>
      'Вы згубіце вашу серыю, ды ваш рахунак будзе захованы.';

  @override
  String get mobilePuzzleThemesSubtitle =>
      'Рашайце задачу з вашага любімага дэбюта, або выберыце тэму.';
  ...
  String get mobileSettingsImmersiveModeSubtitle =>
      'Хавае сістэмны UI пад час гульні. Карыстайцеся гэтым калі вас турбуюць жэсты навігацыі сістэмы па краях экрана. Прымяняецца да экранаў гульні і задач.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Калі актыўна, ваш дэвайс будзе крыху вібраваць калі вы паходзіце або пры ўзяцці фігуры.';
  ...
  String get variantRacingKingsTitle =>
      'Для перамогі трэба давесці свайго караля да канца дошкі першым';
  ...
  String get broadcastTheNewRoundHelp =>
      'У новым туры будуць тыя ж удзельнікі і рэдактары, што і ў папярэдняму.';
  ...
  String get broadcastSourceUrlHelp =>
      'Спасылка, з якой Chessigma паспрабуе атрымоўваць абнаўленні PGN. Яны павінна быць даступнай для кожнай ва Інтэрнэце.';
  ...
  String get broadcastSubscribeTitle =>
      'Падпішыцеся, каб атрымліваць паведамленні аб пачатку кожнага раунда. Вы можаце ўключыць гукавыя ці пуш-паведамленні ў сваіх наладах.';
  ...
  String get coordinatesPracticeOnlySomeFilesAndRanks =>
      'Трэніравацца толькі з некаторымі слупкамі і радкамі';
  ...
  String get puzzleOpeningsYouPlayedTheMost =>
      'Дэбюты, якія вы гулялі часцей за ўсе ў рэйтынгавых гульнях';

  @override
  String get puzzleUseFindInPage =>
      'Карыстайцеся \"Знайсці на старонце\" ў браузеры каб знайсці ваш любімы дэбют!';
  ...
  String get settingsManagedAccountCannotBeClosed =>
      'Ваш уліковы запіс кіруецца на дадзены момант і не можа быць выдален.';
  ...
  String get settingsCloseAccountAreYouSure =>
      'Вы ўпэўнены, што жадаеце выдаліць ваш уліковы запіс?';
  ...
  String get blankedPassword =>
      'Вы выкарыстоўвалі той жа пароль на іншым сайце, і гэты сайт быў узламаны. Каб забяспечыць бяспеку вашага ўліковага запісу Chessigma, трэба каб вы ўсталявалі новы пароль. Дзякуй за разуменне.';
  ...
  String get primaryColorArrowsHowTo =>
      'Ctrl або Shift = чырвоны; Command, Alt, або Meta = сіні; Кожная з іх = жоўты.';
  ...
  String get lostAgainstTOSViolator =>
      'Вы прайгралі камусьці, хто парушыў ўмовы карыстання Chessigma';
