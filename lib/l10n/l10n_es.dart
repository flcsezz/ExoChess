...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Estas preferencias se aplican a tu cuenta de Chessigma y se usarán en todos los dispositivos.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Ten en cuenta que no todas las características de la aplicación anterior o del sitio web están disponibles actualmente, pero agregamos nuevas funciones constantemente.';
  ...
  String get mobilePuzzleStreakAbortWarning =>
      'Perderás tu racha actual y se guardará tu puntuación.';

  @override
  String get mobilePuzzleThemesSubtitle =>
      'Realiza ejercicios sobre tus aperturas favoritas o sobre el tema que elijas.';
  ...
  String get mobileSettingsImmersiveModeSubtitle =>
      'Oculta la interfaz del sistema durante la partida. Úsalo si te molestan los iconos de navegación del sistema en los bordes de la pantalla. Aplica a las pantallas de juego y a las de ejercicios.';
  ...
  String get mobileSettingsPickAnImageHelp =>
      'El fondo personalizado sólo funciona en modo oscuro. Se recomienda una imagen oscura.';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Dibuja formas con dos dedos: mantén un dedo sobre una casilla vacía y arrastra otro dedo para dibujar una figura.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Si está activa, el dispositivo vibrará brevemente cuando muevas o captures una pieza.';
  ...
  @override
  String get mobileWelcomeToChessigmaApp => '¡Bienvenido a la aplicación de Chessigma!';
  ...
  String get mobileCustomizeHomeTip =>
      'Consejo: ¡Puedes añadir más componentes a la pantalla de inicio o eliminar aquellos que no necesitas!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'El explorador de aperturas no está disponible sin conexión.';

  @override
  String get mobileChallengeCreated =>
      'Desafío creado: Se te notificará cuando comience la partida.\\nPuedes acceder a ella desde la pestaña de inicio.';
  ...
  String get variantThreeCheckTitle =>
      'Poner en jaque a tu oponente 3 veces para ganar la partida.';

  @override
  String get variantAntichessTitle =>
      'Pierde todas tus piezas (o una posición de ahogado) para ganar la partida.';
  ...
  String get variantHordeTitle =>
      'Un jugador tiene un gran número de peones, el otro posee un ejército normal.';
  ...
  String get variantCrazyhouseTitle =>
      'Las piezas capturadas pueden volver a colocarse en el tablero en lugar de hacer un movimiento.';
  ...
  @override
  String get activitySignedUp => 'Registrado en Chessigma';
  ...
  String get arenaHowIsTheWinnerDecidedAnswer =>
      'Ganará el jugador (o jugadores) que tenga más puntos al término del torneo.';
  ...
  String get arenaDrawStreakVariants =>
      'La duración mínima de las partidas terminadas en tablas para otorgar puntos difiere según la variante. La siguiente tabla muestra el límite para cada variante.';
  ...
  String get arenaCustomStartDateHelp =>
      'En tu zona horaria. Esto reemplazará la configuración de \"Tiempo antes de que comience el torneo\"';
  ...
  String get arenaAllowBerserkHelp =>
      'Permite a los jugadores reducir su tiempo a la mitad para ganar un punto extra';
  ...
  String get arenaTournamentPairingsAreNowClosed =>
      'Los emparejamientos del torneo están cerrados.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Si la partida acaba en tablas durante los primeros $count movimientos, no se concederán puntos a ninguno de los jugadores.',
      one:
          'Si la partida acaba en tablas durante los primeros $count movimientos, no se concederán puntos a ninguno de los jugadores.',
    );
    return '$_temp0';
  ...
  String get broadcastHowToUseChessigmaBroadcasts =>
      'Como utilizar las transmisiones de Chessigma.';
  ...
  String get broadcastSourceUrlHelp =>
      'URL que Chessigma comprobará para obtener actualizaciones PGN. Debe ser públicamente accesible desde Internet.';

  @override
  String get broadcastSourceGameIds =>
      'Hasta 64 identificadores de partidas de Chessigma, separados por espacios.';
  ...
  @override
  String get broadcastOpenChessigma => 'Abrir en Chessigma';
  ...
  String get broadcastStandingsDisclaimer =>
      'Las clasificaciones se calculan con partidas retransmitidas y pueden ser distintas a las oficiales.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Si mantiene el nombre predeterminado se traducirá automáticamente al resto de idiomas.';
  ...
  @override
  String get challengeInviteChessigmaUser => 'O invita a un usuario de Chessigma:';

  @override
  String get contactContact => 'Contacto';

  @override
  String get contactContactChessigma => 'Contactar con Chessigma';
  ...
  String get coordinatesKnowingTheChessBoard =>
      'Conocer las coordenadas de los escaques es esencial en el ajedrez:';

  @override
  String get coordinatesMostChessCourses =>
      'La mayoría de los cursos y ejercicios de ajedrez usan la notación algebraica.';

  @override
  String get coordinatesTalkToYourChessFriends =>
      'Facilita la comunicación con otros jugadores, que también hablan el \"lenguaje del ajedrez\".';

  @override
  String get coordinatesYouCanAnalyseAGameMoreEffectively =>
      'Puedes analizar partidas de forma más eficiente si no tienes que andar buscando los nombres de los escaques.';

  @override
  String get coordinatesACoordinateAppears =>
      'Una coordenada aparece en el tablero y debes hacer clic en la casilla correspondiente.';

  @override
  String get coordinatesASquareIsHighlightedExplanation =>
      'Una casilla se resalta en el tablero y debes introducir su coordenada (por ejemplo, \"e4\").';

  @override
  String get coordinatesYouHaveThirtySeconds =>
      '¡Tienes 30 segundos para marcar correctamente tantas casillas como sea posible!';

  @override
  String get coordinatesGoAsLongAsYouWant =>
      '¡Tómate todo el tiempo que quieras, no hay límite de tiempo!';
  ...
  @override
  String get patronChessigmaPatron => 'Patrón de Chessigma';

  @override
  String get patronBecomePatron => 'Hazte patrón de Chessigma';
  ...
  @override
  String get preferencesNotifyBell => 'Notificación de campana dentro del Chessigma';

  @override
  String get preferencesNotifyPush => 'Notificación de dispositivo cuando no estés en Chessigma';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      'Dos piezas opuestas se enfrentan entre sí, y una se desliza a lo largo de la línea de ataque sin capturar la pieza enemiga.';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Encierra al rey en una esquina usando una torre o dama y un caballo para dar mate.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'Mueve una pieza para dar jaque con otra que se encuentra detrás, lo que a menudo conduce a una ventaja decisiva.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Las dos casillas de escape adyacentes al rey en jaque están ocupadas por otras piezas.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'La torre da jaque mate, al tiempo que el alfil ayuda a confinar al rey enemigo.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Utiliza el alfil para dar jaque al rey, mientras que tu torre ayuda a mantenerlo confinado.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Un patrón de mate que se asemeja visualmente a la cola de una golondrina, en forma de V.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Da jaque al rey con una torre defendida por un alfil.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Enlace permanente para que cualquiera pueda desafiarte con estos ajustes concretos.';
  ...
  String get unknownDueToRounding =>
      'Victoria o derrota segura solo si se siguió la línea de movimientos recomendados desde la última captura o movimiento de peón, a causa del posible redondeo de valores DTZ de las tablas de finales Sizigia.';
  ...
  String get multipleLinesDescription =>
      'Establece la cantidad de líneas de evaluación y de flechas de movimiento en el tablero';
  ...
  String get threadsDescription =>
      'Establecer número inferior de hilos de la CPU; las marcas dan una elección segura';

  @override
  String get threadsDescriptionMobile =>
      'Más hilos darán un mejor análisis, aunque usará más batería';
  ...
  String get signupEmailPromise =>
      'Solo te enviaremos correos sobre tu cuenta y nunca compartiremos el tuyo.';
  ...
  String get blankedPassword =>
      'Has utilizado la misma contraseña en alguna otra página que fue objeto de un ataque (y expuso tu contraseña). Para garantizar la seguridad de tu cuenta en Chessigma, necesitamos que elijas una contraseña diferente. Gracias por tu comprensión.';

  @override
  String get youAreLeavingChessigma => 'Vas a salir de Chessigma';

  @override
  String get neverTypeYourPassword =>
      '¡Nunca escribas tu contraseña de Chessigma en otras páginas!';
  ...
  String get passwordSuggestion =>
      'No uses una contraseña que te haya sugerido otra persona. Podrían usarla para robar tu cuenta.';

  @override
  String get emailSuggestion =>
      'No uses una dirección de correo electrónico que te haya sugerido otra persona. Podrían usarla para robar tu cuenta.';
  ...
  String get checkSpamFolder =>
      'También comprueba tu carpeta de spam, por si ha ido ahí. En ese caso, márcalo como no spam.';

  @override
  String get emailForSignupHelp =>
      'Si nada de lo anterior funciona, envíanos este texto por correo:';
  ...
  String get thisAccountViolatedTos =>
      'Este usuario no cumple los términos de servicio de Chessigma';
  ...
  String get noDrawBeforeSwissLimit =>
      'No puedes hacer tablas antes de 30 movimientos en un torneo suizo.';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      'Los filtros de valoración están bloqueados porque tu puntuación no es estable. Jugar partidas valoradas aumentará la estabilidad.';
  ...
  String get youCanHideFlair =>
      'Existe una opción para ocultar las insignias de todos los usuarios de la página.';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Anteriormente en Chessigma TV';
  ...
  String get reportUsernameHelp =>
      'Explica por qué es ofensivo este nombre de usuario. No te limites a decir \"es ofensivo\" o \"inapropiado\" y argumenta tu conclusión, sobre todo si el insulto no es tan obvio, no está en inglés, es jerga o una referencia histórica o cultural.';

  @override
  String get reportProcessedFasterInEnglish =>
      'Tu denuncia se procesará más rápido si la escribes en inglés.';
  ...
  String get aboutSimulRealLife =>
      'El concepto de simultáneas en Chessigma se toma de la vida real, donde el anfitrión va de mesa en mesa haciendo sus jugadas.';
  ...
  String get simulAddExtraTimePerPlayer =>
      'Tiempo inicial que se añade a tu reloj por cada oponente que se una a la simultánea.';

  @override
  String get simulHostExtraTimePerPlayer => 'Tiempo extra del anfitrión por cada oponente';

  @override
  String get lichessTournaments => 'Torneos de Chessigma';
  ...
  @override
  String get networkLagBetweenYouAndChessigma => 'Retardo de conexión entre tú y lichess';

  @override
  String get timeToProcessAMoveOnChessigmaServer =>
      'Tiempo para procesar un movimiento en el servidor de Chessigma';
  ...
  String get primaryColorArrowsHowTo =>
      'Ctrl o mayúsculas = rojo; comando, alt, o meta = azul; una tecla de cada = amarillo.';
  ...
  String get drawByFiftyMoves =>
      'La partida ha acabado en tablas por la regla de los cincuenta movimientos.';
  ...
  @override
  String get showUnreadChessigmaMessage => 'Has recibido un mensaje privado de Chessigma.';
  ...
  @override
  String get agreementPolicy => 'Me comprometo a seguir las normas de Chessigma.';
  ...
  String get lostAgainstTOSViolator =>
      'Perdiste contra un usuario que incumplió las Condiciones del Servicio de Chessigma';
  ...
  @override
  String get lichessDbExplanation => 'Partidas por puntos de todos los jugadores de Chessigma';
  ...
  @override
  String get streamerChessigmaStreamers => 'Presentadores de Chessigma';
  ...
  String get studyYouCanPasteThisInTheForumToEmbed =>
      'Puedes pegar esto en el foro o tu blog de Chessigma para insertar la partida';
  ...
  @override
  String get studyWelcomeToChessigmaStudyTitle => '¡Bienvenido a Chessigma Study!';

  @override
  String get studyWelcomeToChessigmaStudyText =>
      'Se trata de un tablero de análisis compartido.<br><br>¡Úsalo para analizar y anotar partidas,<br>discutir posiciones con amigos,<br>y por supuesto para lecciones de ajedrez!<br><br>Es una herramienta poderosa, tomemos algo de tiempo para ver cómo funciona.';
  ...
  String get studySharedAndSavedText =>
      '¡Otros miembros pueden ver tus movimientos en tiempo real!<br>Además, todo se guarda para siempre.';
  ...
  String get studyStudyChaptersText =>
      'Un estudio puede contener varios capítulos.<br>Cada capítulo tiene una posición inicial y un árbol de movimientos distintos.';
  ...
  String get studyAnnotatePositionText =>
      'Haz clic en el botón !? o clic derecho en la lista de movimientos de la derecha.<br>Los comentarios serán compartidos y guardados.';
  ...
  String get studyConclusionText =>
      'Puedes encontrar tus <a href=\'/study/mine/hot\'>estudios previos</a> en tu perfil.<br>También existe un <a href=\'//lichess.org/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way\'>comentario de blog sobre los estudios</a>.<br>Los usuarios avanzados pueden pulsar \"?\" para ver los atajos de teclado.<br>¡Que te diviertas!';
  ...
  String get studyCreateChapterText =>
      'Un estudio puede tener varios capítulos.<br>Cada capítulo tiene un árbol de movimientos distinto,<br>y puede ser creado de varias maneras.';
  ...
  String get studyFromInitialPositionText =>
      'Una configuración de tablero para una partida nueva.<br>Adecuado para explorar aperturas.';
  ...
  String get studyCustomPositionText =>
      'Configura el tablero a tu manera.<br>Apropiado para explorar finales.';

  @override
  String get studyLoadExistingChessigmaGameTitle => 'Cargar una partida de Chessigma existente';

  @override
  String get studyLoadExistingChessigmaGameText =>
      'Pega la URL de una partida de Chessigma<br>(como lichess.org/7fHIU0XI)<br>para cargar los movimientos en el capítulo.';
  ...
  String get studyFromFenStringText =>
      'Pegar una posición en formato FEN<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>para iniciar el capítulo desde una posición.';
  ...
  String get studyFromPgnGameText =>
      'Pega una partida en formato PGN.<br>para cargar movimientos, comentarios y variaciones en el capítulo.';
  ...
  String get studyVariantsAreSupportedText =>
      '¡Sí, puedes estudiar Crazyhouse<br>y todas las variantes de Chessigma!';
