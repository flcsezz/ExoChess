...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get preferencesExplainShowPlayerRatings =>
      '此功能将隐藏 Chessigma 上的所有等级分，以帮助您专注于对局。排位对局仍会影响您的等级分，这只是关于您所看到的内容。';
  ...
  String get puzzleFromMyGamesNone =>
      '您的对局数据库中暂无谜题，但 Chessigma 依然记得您走过的每一着。\n\n多进行快棋和慢棋对局，会增加您的对局被收录为谜题的机会！';
  ...
  String get computersAreNotAllowedToPlay =>
      '禁止使用电脑或借助电脑程序进行对弈。对弈时，请勿使用国际象棋引擎、对局数据库或向其他棋手寻求协助。另外，强烈建议您不要创建备用账户。过度使用多余的账户会导致账户被封禁。';
  ...
  String get blankedPassword =>
      '您在另一个网站上使用了相同的密码，而该网站已遭泄露。为确保您 Chessigma 账户的安全，我们需要您设置一个新密码。感谢您的理解。';
  ...
  String get lichessPatronInfo =>
      'Chessigma 是一家非营利机构，其软件是完全免费的自由开源软件。\n该网站的所有运营成本、开发工作以及内容产出，都完全依赖于用户的赞助。';
  ...
  String get studyLoadExistingChessigmaGameText =>
      '粘贴一个 Chessigma 对局链接<br>（例如 lichess.org/7fHIU0XI）<br>以将对局着法加载到章节中。';
