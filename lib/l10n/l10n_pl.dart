...
class AppLocalizationsPl extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Ustawienia te są przypisane do Twojego konta Chessigma i będą używane na wszystkich urządzeniach.';
  ...
  String get broadcastSourceUrlHelp =>
      'Adres URL, który Chessigma będzie udostępniał, aby można było uzyskać aktualizacje PGN. Musi być publicznie dostępny z internetu.';
  ...
  String get blankedPassword =>
      'Użyłeś tego samego hasła na innej stronie, która padła ofiarą ataku. Aby zapewnić bezpieczeństwo Twojego konta na Chessigma, prosimy o ustawienie nowego hasła. Dziękujemy za wyrozumiałość.';
  ...
  String get thisAccountViolatedTos =>
      'Użytkownik tego konta naruszył warunki korzystania z Chessigma';
  ...
  String get lostAgainstTOSViolator =>
      'Przegrałeś/aś z kimś, kto naruszył warunki użytkowania Chessigma';
  ...
  String get studyLoadExistingChessigmaGameText =>
      'Wklej adres URL partii Chessigma<br>(na przykład lichess.org/7fHIU0XI), <br>aby załadować ruchy do rozdziału.';
  ...
  String get studyVariantsAreSupportedText =>
      'Tak, możesz studiować crazyhouse<br>i wszystkie inne warianty dostępne na Chessigma!';
