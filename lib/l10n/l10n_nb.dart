...
class AppLocalizationsNb extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Disse innstillingene gjelder for din Chessigma-konto og vil bli brukt på alle enhetene dine.';
  ...
  String get broadcastSourceUrlHelp =>
      'Lenke som Chessigma vil hente PGN-oppdateringer fra. Den må være offentlig tilgjengelig på internett.';

  @override
  String get broadcastSourceGameIds =>
      'Opptil 64 ID-er for partier hos Chessigma. De må være adskilt med mellomrom.';
  ...
  String get puzzleFromMyGamesNone =>
      'Du har ingen sjakknøtter i databasen, men Chessigma setter like fullt umåtelig stor pris på deg.\nSpill partier i hurtigsjakk og klassisk sjakk for å øke sjansen for å få med en sjakknøtt!';
  ...
  String get studyLoadExistingChessigmaGameText =>
      'Lim inn en URL til et Chessigma-parti<br>(som lichess.org/7fHIU0XI)<br>for å laste inn trekkene fra partiet i kapittelet.';
  ...
  String get studyVariantsAreSupportedText =>
      'Ja, du kan studere crazyhouse<br>og alle Chessigma-varianter!';
