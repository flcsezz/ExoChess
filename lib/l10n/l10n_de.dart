...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Diese Einstellungen werden auf dein Chessigma - Konto angewendet und werden auf allen Geräten verwendet.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Bitte beachte, dass derzeit nicht alle Funktionen der alten App oder der Website verfügbar sind, aber wir fügen ständig Funktionen hinzu.';
  ...
  String get mobileSettingsPickAnImageHelp =>
      'Benutzerdefinierte Hintergründe funktionieren nur im Dunkelmodus. Ein dunkles Bild wird empfohlen.';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Zeichne Formen mit zwei Fingern: Halte einen Finger auf einem leeren Feld und ziehe den anderen Finger um eine Form zu zeichnen.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Wenn aktiviert, vibriert dein Gerät kurz, wenn du eine Figur bewegst oder schlägst.';
  ...
  String get mobileCustomizeHomeTip =>
      'Tipp: Du kannst weitere Widgets zum Startbildschirm hinzufügen oder die entfernen, die du nicht benötigst!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Der Eröffnungs-Explorer ist offline nicht verfügbar.';

  @override
  String get mobileChallengeCreated =>
      'Herausforderung erstellt: Du wirst benachrichtigt, wenn die Partie beginnt.\\n Du kannst über den Home-Tab darauf zugreifen.';
  ...
  String get variantChess960Title =>
      'Die Startposition der Figuren auf der Grundreihe wird zufällig ermittelt.';

  @override
  String get variantKingOfTheHillTitle =>
      'Bring deinen König in die Mitte, um die Partie zu gewinnen.';

  @override
  String get variantThreeCheckTitle =>
      'Biete deinem Gegner dreimal Schach, um diese Partie zu gewinnen.';

  @override
  String get variantAntichessTitle =>
      'Verliere alle deine Figuren (oder werde Patt gesetzt), um diese Partie zu gewinnen.';
  ...
  String get variantHordeTitle =>
      'Die eine Seite besitzt eine große Anzahl an Bauern, die andere eine normale Armee.';

  @override
  String get variantRacingKingsTitle =>
      'Bringe deinen König auf die andere Seite des Bretts, um zu gewinnen.';

  @override
  String get variantCrazyhouseTitle =>
      'Geschlagene Figuren können, statt eines regulären Zuges, auf das Brett zurückgebracht werden.';
  ...
  String get arenaIsRated =>
      'Dieses Turnier ist gewertet und wird deine Wertungszahl beeinflussen.';

  @override
  String get arenaIsNotRated =>
      'Dieses Turnier ist *nicht* gewertet und wird deine Wertungszahl *nicht* beeinflussen.';

  @override
  String get arenaSomeRated =>
      'Manche Turniere sind gewertet und werden deine Wertungszahl beeinflussen.';
  ...
  String get arenaHowDoesItEndAnswer =>
      'Während des Turniers wird die Zeit heruntergezählt. Wenn sie null erreicht, wird die Rangliste eingefroren und der Gewinner bekannt gegeben. Laufende Partien müssen beendet werden, zählen aber nicht mehr für das Turnier.';
  ...
  String get arenaDrawStreakVariants =>
      'Die minimale Partie-Länge, um für remisierte Partien Punkte zu erhalten, unterscheidet sich je nach gespielter Variante. Die Tabelle unten listet die Grenzen für jede Variante auf.';
  ...
  String get arenaCustomStartDateHelp =>
      'In deiner eigenen, lokalen Zeitzone. Dies wird die Einstellung \"Zeit bevor das Turnier beginnt\" überschreiben';
  ...
  String get arenaAllowBerserkHelp =>
      'Lasse Spieler ihre Bedenkzeit halbieren, um einen zusätzlichen Punkt zu erzielen';
  ...
  String get arenaArenaStreaksHelp =>
      'Nach 2 Siegen gewähren aufeinander folgende Siege 4 Punkte anstelle von 2.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Bei Remis innerhalb der ersten $count Züge werden keinem Spieler Punkte gut geschrieben.',
  ...
  String get broadcastSourceUrlHelp =>
      'URL die Chessigma abfragt um PGN Aktualisierungen zu erhalten. Sie muss öffentlich aus dem Internet zugänglich sein.';

  @override
  String get broadcastSourceGameIds =>
      'Bis zu 64 Chessigma Partie-IDs, getrennt durch Leerzeichen.';
  ...
  String get broadcastStandingsDisclaimer =>
      'Die Platzierungen werden anhand der übertragenen Partien berechnet und können sich von den offiziellen Ergebnissen unterscheiden.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Wenn der Standardname beibehalten wird, wird er automatisch in alle anderen Sprachen übersetzt.';
  ...
  String get coordinatesACoordinateAppears =>
      'Es erscheint eine Koordinate auf dem Brett und du musst auf das entsprechende Feld klicken.';

  @override
  String get coordinatesASquareIsHighlightedExplanation =>
      'Ein Feld wird auf dem Brett hervorgehoben und du musst dessen Koordinate eingeben (z. B. „e4“).';

  @override
  String get coordinatesYouHaveThirtySeconds =>
      'Du hast 30 Sekunden, um so viele Felder wie möglich korrekt zu benennen!';

  @override
  String get coordinatesGoAsLongAsYouWant =>
      'Spiele so lange du willst, es gibt keine Zeitbegrenzung!';
  ...
  String get puzzleThemeAdvancedPawnDescription =>
      'Einer deiner Bauern ist tief in die gegnerische Stellung vorgerückt und droht möglicherweise umzuwandeln.';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Sperrt den König in einer Ecke des Bretts ein, um dann mit Turm oder Dame und einem Springer Matt zu setzen.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'Bewege eine Figur, um mit einer anderen versteckten Figur ein Schach zu gebe, was oft zu entscheidendem Vorteil führt.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Zwei benachbarte Fluchtfelder für einen im Schach stehenden König werden von anderen Figuren besetzt.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'Der Turm setzt Matt, während der Läufer hilft, ihn zu beschränken.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Benutze den Läufer, um den König ins Schach zu stellen, während dein Turm ihn weiter beschränkt.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Ein Mattmuster, das dem Erscheinungsbild eines Schwalbenschwanzes ähnelt, ähnlich einer V-Form.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Stelle den König mithilfe deines Turms ins Schach und benutze einen Läufer, um den Turm zu verteidigen.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Ein permanenter Link für jeden, der dich mit genau diesen Einstellungen herausfordert.';
  ...
  String get multipleLinesDescription =>
      'Anzahl der besten Züge und Zug-Pfeile auf dem Brett festlegen';
  ...
  String get threadsDescription =>
      'Setze sie unterhalb deiner CPU-Kernanzahl fest, die Ticks markieren eine gute und sichere Wahl';

  @override
  String get threadsDescriptionMobile =>
      'Mehr Threads verbrauchen mehr Akku für eine bessere Analyse';
  ...
  String get signupEmailPromise =>
      'Wir werden dir nur E-Mails bezüglich deines Kontos senden und niemals deine E-Mail-Adresse weitergeben.';
  ...
  String get blankedPassword =>
      'Du hast das gleiche Passwort auf einer anderen Seite verwendet und diese Seite wurde kompromittiert. Um die Sicherheit deines Chessigma-Kontos zu gewährleisten, musst du ein neues Passwort setzen. Danke für dein Verständnis.';
  ...
  String get neverTypeYourPassword =>
      'Gib dein Chessigma-Passwort niemals auf einer anderen Seite ein!';
  ...
  String get thisAccountViolatedTos =>
      'Dieses Konto hat gegen die Chessigma-Nutzungsbedingungen verstoßen';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      'Die Filter nach Wertungszahl sind gesperrt, da deine Wertungszahl nicht stabil ist. Gewertete Partien zu spielen erhöht die Stabilität deiner Wertung.';
  ...
  String get ifYouDoNotGetTheEmail =>
      'Falls du keine E-Mail innerhalb der nächsten 5 Minuten erhältst:';
  ...
  String get timeToProcessAMoveOnChessigmaServer =>
      'Zeit, um einen Zug auf dem Chessigma-Server zu verarbeiten';
  ...
  String get primaryColorArrowsHowTo =>
      'Strg oder Shift = rot; Befehl, Alt oder Meta = Blau; von beiden eine Taste = Gelb.';
  ...
  String get lostAgainstTOSViolator =>
      'Du hast Elo an jemanden verloren, der gegen die Chessigma -AGB verstoßen hat';
  ...
  String get lichessPatronInfo =>
      'Chessigma ist eine Wohltätigkeitsorganisation und eine völlig kostenlose/freie Open-Source-Software.\nAlle Betriebskosten, Entwicklung und Inhalte werden ausschließlich durch Benutzerspenden finanziert.';
  ...
  String get studyWelcomeToChessigmaStudyText =>
      'Dies ist ein geteiltes Analysebrett.<br><br>Verwende es, um Spiele zu analysieren und zu kommentieren,<br>diskutiere Stellungen mit Freunden,<br>und verwende es natürlich für den Schachunterricht!<br><br>Es ist ein mächtiges Werkzeug, nehmen wir uns etwas Zeit, um zu sehen, wie es funktioniert.';
  ...
  String get studySharedAndSavedText =>
      'Andere Mitglieder können deine Züge in Echtzeit sehen!<br> Zusätzlich wird alles für immer gespeichert.';
  ...
  String get studyStudyChaptersText =>
      'Eine Studie kann mehrere Kapitel beinhalten.<br> Jedes Kapitel hat eine vordefinierte Ausgangsstellung und Zugbaum.';
  ...
  String get studyAnnotatePositionText =>
      'Klicke auf den !? Knopf oder rechts-klicke auf die Zugliste auf der rechten Seite.<br> Kommentar-Symbole werden geteilt und gespeichert.';
  ...
  String get studyCreateChapterText =>
      'Eine Studie kann mehrere Kapitel haben.<br>Jedes Kapitel hat einen eigenen Zugbaum,<br>und kann auf verschiedene Arten erstellt werden.';
  ...
  String get studyFromInitialPositionText =>
      'Nur eine Brettstellung für eine neue Partie.<br>Geeignet, um Eröffnungen zu erkunden.';
  ...
  String get studyCustomPositionText =>
      'Baue das Brett auf deine eigene Weise auf.<br>Geeignet, um Endspiele zu erkunden.';
  ...
  String get studyFromFenStringText =>
      'Fügen eine Position im FEN-Format<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>ein, um das Kapitel von dieser Stellung aus zu starten.';
  ...
  String get studyFromPgnGameText =>
      'Füge eine Partie im PGN-Format ein,<br>um Züge, Kommentare und Varianten in das Kapitel zu laden.';
  ...
  String get studyVariantsAreSupportedText =>
      'Ja, du kannst Crazyhouse<br>und alle Chessigma -Varianten studieren!';
