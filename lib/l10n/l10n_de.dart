...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get mobileAccountPreferencesHelp => 'Diese Einstellungen werden auf dein Chessigma - Konto angewendet und werden auf allen Geräten verwendet.';
  ...
  @override
  String get mobilePuzzleStormFilterNothingToShow => 'Nichts anzuzeigen, bitte passe deine Filter an';

  @override
  String get mobilePuzzleStormNothingToShow => 'Nichts anzuzeigen. Spiele ein paar Runden Puzzle Storm.';
  ...
  @override
  String get mobileWelcomeToChessigmaApp => 'Willkommen bei der Chessigma-App!';
  ...
  @override
  String get activitySignedUp => 'Hat sich bei Chessigma angemeldet';
  ...
  @override
  String get arenaArenaTournaments => 'Arena-Turniere';

  @override
  String get arenaIsItRated => 'Sind die Partien gewertet?';

  @override
  String get arenaWillBeNotified => 'Du wirst benachrichtigt, wenn das Turnier beginnt. Es ist somit möglich, während der Wartezeit in einem anderen Tab zu spielen.';

  @override
  String get arenaIsRated => 'Dieses Turnier ist gewertet und wird deine Wertungszahl beeinflussen.';

  @override
  String get arenaIsNotRated => 'Dieses Turnier ist *nicht* gewertet und wird deine Wertungszahl *nicht* beeinflussen.';

  @override
  String get arenaSomeRated => 'Manche Turniere sind gewertet und werden deine Wertungszahl beeinflussen.';
  ...
  @override
  String get arenaHowDoesItEndAnswer => 'Während des Turniers wird die Zeit heruntergezählt. Wenn sie null erreicht, wird die Rangliste eingefroren und der Gewinner bekannt gegeben. Laufende Partien müssen beendet werden, zählen aber nicht mehr für das Turnier.';

  @override
  String get arenaOtherRules => 'Andere wichtige Regeln';

  @override
  String get arenaThereIsACountdown => 'Es gibt einen Countdown für deinen ersten Zug. Ziehst du nicht innerhalb dieser Zeit, wird der Sieg deinem Gegner zugesprochen.';

  @override
  String get arenaThisIsPrivate => 'Dies ist ein privates Turnier';

  @override
  String arenaShareUrl(String param) {
    return 'Teile diese URL, um andere einzuladen: $param';
  }

  @override
  String arenaDrawStreakStandard(String param) {
    return 'Remis-Serien: Wenn ein Spieler in mehreren aufeinanderfolgenden Arena-Partien Remis erzielt, wird nur für das erste Remis und in Standard-Partien für Remis, in denen mehr als $param Züge gespielt wurden, ein Punkt vergeben. Eine Remis-Serie kann nur durch einen Sieg gebrochen werden, nicht durch eine verlorene Partie oder ein Unentschieden.';
  }

  @override
  String get arenaDrawStreakVariants => 'Die minimale Partie-Länge, um für remisierte Partien Punkte zu erhalten, unterscheidet sich je nach gespielter Variante. Die Tabelle unten listet die Grenzen für jede Variante auf.';

  @override
  String get arenaVariant => 'Variante';

  @override
  String get arenaMinimumGameLength => 'Minimale Partie-Länge';

  @override
  String get arenaHistory => 'Arena-Historie';

  @override
  String get arenaNewTeamBattle => 'Neuer Teamkampf';

  @override
  String get arenaCustomStartDate => 'Benutzerdefiniertes Startdatum';

  @override
  String get arenaCustomStartDateHelp => 'In deiner eigenen, lokalen Zeitzone. Dies wird die Einstellung \"Zeit bevor das Turnier beginnt\" überschreiben';

  @override
  String get arenaAllowBerserk => 'Berserk erlauben';

  @override
  String get arenaAllowBerserkHelp => 'Lasse Spieler ihre Bedenkzeit halbieren, um einen zusätzlichen Punkt zu erzielen';

  @override
  String get arenaAllowChatHelp => 'Lasse Spieler in einem Chatraum diskutieren';

  @override
  String get arenaArenaStreaks => 'Arena-Siegesserien';

  @override
  String get arenaArenaStreaksHelp => 'Nach 2 Siegen gewähren aufeinander folgende Siege 4 Punkte anstelle von 2.';

  @override
  String get arenaNoBerserkAllowed => 'Kein Berserken erlaubt';

  @override
  String get arenaNoArenaStreaks => 'Keine Arena-Siegesserien';

  @override
  String get arenaAveragePerformance => 'Durchschnittliche Leistung';

  @override
  String get arenaAverageScore => 'Durchschnittliche Punktzahl';

  @override
  String get arenaMyTournaments => 'Meine Turniere';

  @override
  String get arenaEditTournament => 'Turnier bearbeiten';
  ...
  @override
  String get arenaWhichTeamWillYouRepresentInThisBattle => 'Welches Team wirst du in diesem Kampf repräsentieren?';

  @override
  String get arenaYouMustJoinOneOfTheseTeamsToParticipate => 'Du musst dich einem dieser Teams anschließen, um teilnehmen zu können!';

  @override
  String get arenaCreated => 'Erstellt';

  @override
  String get arenaRecentlyPlayed => 'Kürzlich gespielt';

  @override
  String get arenaBestResults => 'Beste Ergebnisse';
  ...
  String arenaAllAveragesAreX(String param) {
    return 'Alle Durchschnittswerte auf dieser Seite sind $param.';
  }

  @override
  String get arenaTotal => 'Gesamt';

  @override
  String get arenaPointsAvg => 'Punkte im Schnitt';

  @override
  String get arenaPointsSum => 'Punkte insgesamt';

  @override
  String get arenaRankAvg => 'Platzierungs-Durchschnitt';

  @override
  String get arenaTournamentWinners => 'Turniersieger';

  @override
  String get arenaTournamentShields => 'Turnier-Schilde';

  @override
  String get arenaOnlyTitled => 'Nur Spieler mit Titel';

  @override
  String get arenaOnlyTitledHelp => 'Für die Teilnahme am Turnier ist ein offizieller Titel erforderlich';

  @override
  String get arenaTournamentPairingsAreNowClosed => 'Die Turnierpaarungen sind jetzt geschlossen.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Bei Remis innerhalb der ersten $count Züge werden keinem Spieler Punkte gut geschrieben.',
      one: 'Remis innerhalb des ersten Zugs wird keinem Spieler Punkte einbringen.',
    );
    return '$_temp0';
  }
  ...
  String arenaViewAllXTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Alle $count Teams ansehen',
      one: 'Das Team ansehen',
    );
    return '$_temp0';
  }
  ...
  @override
  String get broadcastHowToUseChessigmaBroadcasts => 'Wie man Chessigma -Übertragungen benutzt.';

  @override
  String get broadcastTheNewRoundHelp => 'Die nächste Runde wird die gleichen Mitspieler und Mitwirkende haben wie die vorhergehende.';
  ...
  @override
  String get broadcastSourceUrlHelp => 'URL die Chessigma abfragt um PGN Aktualisierungen zu erhalten. Sie muss öffentlich aus dem Internet zugänglich sein.';

  @override
  String get broadcastSourceGameIds => 'Bis zu 64 Chessigma Partie-IDs, getrennt durch Leerzeichen.';

  @override
  String broadcastStartDateTimeZone(String param) {
    return 'Startdatum in der Zeitzone des Turnierstandortes: $param';
  }
  ...
  @override
  String get broadcastOpenChessigma => 'In Chessigma öffnen';
  ...
  @override
  String get broadcastSubscribeTitle => 'Abonnieren, um bei Rundenbeginn benachrichtigt zu werden. Du kannst in deinen Benutzereinstellungen für Übertragungen zwischen einer Benachrichtigung per Glocke oder per Push-Benachrichtigung wählen.';
  ...
  @override
  String get broadcastStandingsDisclaimer => 'Die Platzierungen werden anhand der übertragenen Partien berechnet und können sich von den offiziellen Ergebnissen unterscheiden.';
  ...
  @override
  String get broadcastMatchPoints => 'Match-Punkte';

  @override
  String get broadcastGamePoints => 'Partie-Punkte';

  @override
  String get broadcastMatches => 'Paarungen';

  @override
  String get broadcastMatchHistory => 'Spielverlauf';

  @override
  String get broadcastTeamResults => 'Teamergebnisse';

  @override
  String broadcastTermsAutomaticallyTranslated(String param) {
    return 'Die folgenden Begriffe werden automatisch übersetzt: $param.';
  }
  ...
  @override
  String get broadcastWomenTournament => 'Frauen';

  @override
  String get broadcastMenTournament => 'Männer';

  @override
  String get broadcastGirlsTournament => 'Mädchen';

  @override
  String get broadcastBoysTournament => 'Jungen';
  ...
  String broadcastGirlsUnderXAgeTournament(String param) {
    return 'Mädchen U$param';
  }

  @override
  String broadcastBoysUnderXAgeTournament(String param) {
    return 'Jungen U$param';
  }

  @override
  String get broadcastQuarterfinals => 'Viertelfinale';

  @override
  String get broadcastSemifinals => 'Halbfinale';
  ...
  @override
  String get challengeInviteChessigmaUser => 'Oder lade einen Chessigma-Benutzer ein:';

  @override
  String get contactContact => 'Kontakt';

  @override
  String get contactContactChessigma => 'Chessigma kontaktieren';
  ...
  String coordinatesAverageScoreAsWhiteX(String param) {
    return 'Durchschnittliche Punktzahl als Weiß: $param';
  }

  @override
  String coordinatesAverageScoreAsBlackX(String param) {
    return 'Durchschnittliche Punktzahl als Schwarz: $param';
  }

  @override
  String get coordinatesKnowingTheChessBoard => 'Die Koordinaten des Schachbretts zu kennen ist eine wichtige Fähigkeit:';

  @override
  String get coordinatesMostChessCourses => 'Die meisten Schach-Kurse und Übungen verwenden die algebraische Notation.';

  @override
  String get coordinatesTalkToYourChessFriends => 'Es macht es einfacher dich mit deinen Schachfreunden zu unterhalten, da ihr beide die \"Schachsprache\" versteht.';

  @override
  String get coordinatesYouCanAnalyseAGameMoreEffectively => 'Du kannst ein Spiel effektiver analysieren, wenn du nicht immer nach den Feldbezeichnungen suchen musst.';

  @override
  String get coordinatesACoordinateAppears => 'Es erscheint eine Koordinate auf dem Brett und du musst auf das entsprechende Feld klicken.';

  @override
  String get coordinatesASquareIsHighlightedExplanation => 'Ein Feld wird auf dem Brett hervorgehoben und du musst dessen Koordinate eingeben (z. B. „e4“).';

  @override
  String get coordinatesYouHaveThirtySeconds => 'Du hast 30 Sekunden, um so viele Felder wie möglich korrekt zu benennen!';

  @override
  String get coordinatesGoAsLongAsYouWant => 'Spiele so lange du willst, es gibt keine Zeitbegrenzung!';

  @override
  String get coordinatesShowCoordinates => 'Koordinaten anzeigen';

  @override
  String get coordinatesShowCoordsOnAllSquares => 'Koordinaten auf jedem Feld';

  @override
  String get coordinatesShowPieces => 'Figuren anzeigen';

  @override
  String get coordinatesStartTraining => 'Training beginnen';

  @override
  String get coordinatesFindSquare => 'Feld finden';
  ...
  @override
  String get patronBecomePatron => 'Werde Chessigma Patron';
  ...
  @override
  String get preferencesNotifyBell => 'Benachrichtigungs-Glocke auf Chessigma';

  @override
  String get preferencesNotifyPush => 'Geräte-Benachrichtigung wenn du nicht auf Chessigma bist';
  ...
  @override
  String get puzzleFromMyGamesNone => 'Es befinden sich keine Aufgaben aus deinen Partien in der Datenbank, aber Chessigma schätzt dich immer noch sehr.\n\nSpiele Schnellschach und klassische Partien, um deine Chancen zu erhöhen, dass eine Aufgabe aus deinen Partien hinzugefügt wird!';
  ...
  @override
  String get puzzleThemeAdvancedPawnDescription => 'Einer deiner Bauern ist tief in die gegnerische Stellung vorgerückt und droht möglicherweise umzuwandeln.';
  ...
  @override
  String get puzzleThemeMixDescription => 'Ein bisschen von allem. Du weißt nicht, was dich erwartet, deshalb bleibst du bereit für alles! Genau wie in echten Partien.';
  ...
  @override
  String get reusableChallengeUrl => 'Wiederverwendbare Herausforderungs-URL';

  @override
  String get permanentLinkForAnyoneToChallengeYou => 'Ein permanenter Link für jeden, der dich mit genau diesen Einstellungen herausfordert.';
  ...
  @override
  String get drawClaimed => 'Remis reklamiert';
  ...
  @override
  String get signupEmailPromise => 'Wir werden dir nur E-Mails bezüglich deines Kontos senden und niemals deine E-Mail-Adresse weitergeben.';
  ...
  @override
  String get blankedPassword => 'Du hast das gleiche Passwort auf einer anderen Seite verwendet und diese Seite wurde kompromittiert. Um die Sicherheit deines Chessigma-Kontos zu gewährleisten, musst du ein neues Passwort setzen. Danke für dein Verständnis.';

  @override
  String get youAreLeavingChessigma => 'Du verlässt Chessigma';

  @override
  String get neverTypeYourPassword => 'Gib dein Chessigma-Passwort niemals auf einer anderen Seite ein!';
  ...
  @override
  String get ratingFilter => 'Bewertungsfilter';

  @override
  String get thisAccountViolatedTos => 'Dieses Konto hat gegen die Chessigma-Nutzungsbedingungen verstoßen';
  ...
  @override
  String get moveAnnotations => 'Zugnotation';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Zuletzt auf Chessigma TV';
  ...
  @override
  String get lichessTournaments => 'Chessigma Turniere';
  ...
  @override
  String get toggleVariationArrows => 'Varianten-Pfeile ein-/auschalten';
  ...
  @override
  String get ifYouDoNotGetTheEmail => 'Falls du keine E-Mail innerhalb der nächsten 5 Minuten erhältst:';

  @override
  String get checkAllEmailFolders => 'Überprüfe alle Müll-, Spam- und anderen Ordner';

  @override
  String verifyYourAddress(String param) {
    return 'Überprüfen, ob $param deine E-Mail-Adresse ist';
  }
  ...
  @override
  String get networkLagBetweenYouAndChessigma => 'Netzwerkverzögerung zwischen dir und Chessigma';

  @override
  String get timeToProcessAMoveOnChessigmaServer => 'Zeit, um einen Zug auf dem Chessigma-Server zu verarbeiten';
  ...
  @override
  String get downloadAllGames => 'Lade alle Partien herunter';
  ...
  String inKidModeTheChessigmaLogoGetsIconX(String param) {
    return 'Im Kindermodus erhält das Chessigma-Logo ein $param-Icon, an dem erkennen kannst, dass deine Kinder geschützt sind.';
  }
  ...
  @override
  String get showUnreadChessigmaMessage => 'Du hast eine private Nachricht von Chessigma erhalten.';
  ...
  @override
  String get agreementPolicy => 'Ich stimme zu, dass ich allen Chessigma-Richtlinien folgen werde.';
  ...
  @override
  String get lostAgainstTOSViolator => 'Du hast Elo an jemanden verloren, der gegen die Chessigma -AGB verstoßen hat';
  ...
  @override
  String get lichessDbExplanation => 'Aus gewerteten Partien aller Chessigma-Spieler';
  ...
  @override
  String get lichessPatronInfo => 'Chessigma ist eine Wohltätigkeitsorganisation und eine völlig kostenlose/freie Open-Source-Software.\nAlle Betriebskosten, Entwicklung und Inhalte werden ausschließlich durch Benutzerspenden finanziert.';
  ...
  @override
  String get streamerChessigmaStreamers => 'Chessigma Streamer';
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Bitte lade nur Leute ein, die dich kennen und die aktiv an dieser Studie teilnehmen möchten.';
  ...
  @override
  String get studyOnlyContributorsCanRequestAnalysis => 'Nur Mitwirkende an der Studie können eine Computeranalyse anfordern.';

  @override
  String get studyGetAFullComputerAnalysis => 'Erhalte eine vollständige serverseitige Computeranalyse der Hauptvariante.';

  @override
  String get studyMakeSureTheChapterIsComplete => 'Stelle sicher, dass das Kapitel vollständig ist. Die Analyse kann nur einmal angefordert werden.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition => 'Alle synchronisierten Mitglieder sehen die gleiche Stellung';

  @override
  String get studyShareChanges => 'Teile Änderungen mit den Zuschauern und speichere sie auf dem Server';
  ...
  @override
  String get studyOnlyPublicStudiesCanBeEmbedded => 'Nur öffentliche Studien können eingebunden werden!';
  ...
  @override
  String get studyDeleteThisChapter => 'Kapitel löschen. Dies kann nicht rückgängig gemacht werden!';

  @override
  String get studyClearAllCommentsInThisChapter => 'Alle Kommentare, Symbole und gezeichnete Formen in diesem Kapitel löschen';
  ...
  @override
  String get studyDeleteTheStudyChatHistory => 'Chatverlauf der Studie löschen? Dies kann nicht rückgängig gemacht werden!';
  ...
  @override
  String get studyGetTheTour => 'Brauchst du Hilfe? Hol dir die Tour!';

  @override
  String get studyWelcomeToChessigmaStudyTitle => 'Willkommen bei den Chessigma -Studien!';

  @override
  String get studyWelcomeToChessigmaStudyText => 'Dies ist ein geteiltes Analysebrett.<br><br>Verwende es, um Spiele zu analysieren und zu kommentieren,<br>diskutiere Stellungen mit Freunden,<br>und verwende es natürlich für den Schachunterricht!<br><br>Es ist ein mächtiges Werkzeug, nehmen wir uns etwas Zeit, um zu sehen, wie es funktioniert.';

  @override
  String get studySharedAndSaveTitle => 'Geteilt und gespeichert';

  @override
  String get studySharedAndSavedText => 'Andere Mitglieder können deine Züge in Echtzeit sehen!<br> Zusätzlich wird alles für immer gespeichert.';

  @override
  String get studyStudyMembersTitle => 'Studienmitglieder';

  @override
  String studyStudyMembersText(String param1, String param2) {
    return '$param1 Zuschauer können die Studie ansehen und im Chat miteinander sprechen.<br><br>$param2 Mitwirkende können Züge ausführen und die Studie aktualisieren.';
  }

  @override
  String studyAddMembersText(String param) {
    return 'Klicke auf den $param Knopf.<br> Entscheide dann, wer oder wer nicht beitragen darf.';
  }

  @override
  String get studyStudyChaptersTitle => 'Studienkapitel';

  @override
  String get studyStudyChaptersText => 'Eine Studie kann mehrere Kapitel beinhalten.<br> Jedes Kapitel hat eine vordefinierte Ausgangsstellung und Zugbaum.';

  @override
  String get studyCommentPositionTitle => 'Kommentiere diese Stellung';

  @override
  String studyCommentPositionText(String param) {
    return 'Klicke auf den $param Knopf oder rechts-klicke auf die Zugliste auf der rechten Seite.<br> Kommentare werden geteilt und gespeichert.';
  }

  @override
  String get studyAnnotatePositionTitle => 'Kommentiere die Stellung';

  @override
  String get studyAnnotatePositionText => 'Klicke auf den !? Knopf oder rechts-klicke auf die Zugliste auf der rechten Seite.<br> Kommentar-Symbole werden geteilt und gespeichert.';

  @override
  String get studyConclusionTitle => 'Danke für Deine Zeit';

  @override
  String get studyConclusionText => 'Du findest deine <a href=\'/study/mine/hot\'>früheren Studien</a> auf deiner Profilseite.<br>Es gibt auch einen <a href=\'//lichess.org/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way\'>Blogbeitrag über Studien</a>.<br>Power-Benutzer möchten vielleicht \"?\" drücken, um Tastaturkürzel zu sehen.<br>Viel Spaß!';

  @override
  String get studyCreateChapterTitle => 'Lass uns ein Studienkapitel erstellen';

  @override
  String get studyCreateChapterText => 'Eine Studie kann mehrere Kapitel haben.<br>Jedes Kapitel hat einen eigenen Zugbaum,<br>und kann auf verschiedene Arten erstellt werden.';

  @override
  String get studyFromInitialPositionTitle => 'Von Ausgangsstellung beginnen';

  @override
  String get studyFromInitialPositionText => 'Nur eine Brettstellung für eine neue Partie.<br>Geeignet, um Eröffnungen zu erkunden.';

  @override
  String get studyCustomPositionTitle => 'Benutzerdefinierte Stellung';

  @override
  String get studyCustomPositionText => 'Baue das Brett auf deine eigene Weise auf.<br>Geeignet, um Endspiele zu erkunden.';

  @override
  String get studyLoadExistingChessigmaGameTitle => 'Lade eine vorhandene Chessigma-Partie';

  @override
  String get studyLoadExistingChessigmaGameText => 'Füge eine lichess-Partie URL <br>(wie z.B. lichess.org/7fHIU0XI)<br>ein, um die Züge der Partie in das Kapitel zu laden.';

  @override
  String get studyFromFenStringTitle => 'Aus einer FEN-Zeichenkette';

  @override
  String get studyFromFenStringText => 'Fügen eine Position im FEN-Format<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>ein, um das Kapitel von dieser Stellung aus zu starten.';

  @override
  String get studyFromPgnGameTitle => 'Aus einer PGN';

  @override
  String get studyFromPgnGameText => 'Füge eine Partie im PGN-Format ein,<br>um Züge, Kommentare und Varianten in das Kapitel zu laden.';

  @override
  String get studyVariantsAreSupportedTitle => 'Studien unterstützen Schachvarianten';

  @override
  String get studyVariantsAreSupportedText => 'Ja, du kannst Crazyhouse<br>und alle Chessigma -Varianten studieren!';

  @override
  String get studyChapterConclusionText => 'Kapitel werden für immer gespeichert.<br> Viel Spaß beim Organisieren deines Schachinhalts!';

  @override
  String get studyDoubleDefeat => 'Doppelte Niederlage';

  @override
  String get studyBlackDefeatWhiteCanNotWin => 'Niederlage von Schwarz, aber Weiß kann nicht gewinnen';

  @override
  String get studyWhiteDefeatBlackCanNotWin => 'Niederlage von Weiß, aber Schwarz kann nicht gewinnen';
