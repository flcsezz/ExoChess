...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Αυτές οι ρυθμίσεις αποθηκεύονται στον λογαριασμό σας στο Chessigma και θα ισχύουν σε όλες τις συσκευές σας.';
  ...
  String get broadcastSourceUrlHelp =>
      'Η διεύθυνση URL την οποία θα χρησιμοποιήσει το Chessigma για τη λήψη ενημερώσεων για τα αρχεία PGN. Πρέπει να είναι δημόσια προσβάσιμη στο διαδίκτυο.';

  @override
  String get broadcastSourceGameIds =>
      'Έως και 64 αναγνωριστικά (id) παρτίδων Chessigma, χωρισμένα με κενά.';
  ...
  String get neverTypeYourPassword =>
      'Ποτέ μην πληκτρολογήσετε τον κωδικό σας από το Chessigma σε άλλον ιστότοπο!';
  ...
  String get thisAccountViolatedTos =>
      'Αυτός ο λογαριασμός παραβίασε τους όρους χρήσης του Chessigma';
  ...
  String get lostAgainstTOSViolator =>
      'Χάσατε από κάποιον που παραβίασε τους όρους χρήσης του Chessigma';
  ...
  String get studyYouCanPasteThisInTheForumToEmbed =>
      'Επικολλήστε την παραπάνω διεύθυνση URL στο φόρουμ ή στο ιστολόγιό σας στο Chessigma αν θέλετε να ενσωματώσετε το κεφάλαιο';
  ...
  String get studyLoadExistingChessigmaGameText =>
      'Επικολλήστε τη διεύθυνση URL μιας παρτίδας στο Chessigma<br>(π.χ. lichess.org/7fHIU0XI)<br>για να φορτώσετε τις κινήσεις της σε αυτό το κεφάλαιο.';
  ...
  String get studyVariantsAreSupportedText =>
      'Μπορείτε να δημιουργήσετε μία μελέτη Crazyhouse<br>η μία μελέτη με οποιαδήποτε άλλη παραλλαγή υποστηρίζει το Chessigma!';
