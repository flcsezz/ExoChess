...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get arenaArena => 'Алаң';

  @override
  String get arenaArenaTournaments => 'Жарыс алаңы';

  @override
  String get arenaIsItRated => 'Бұл бағалана ма?';

  @override
  String get arenaWillBeNotified => 'Жарыс басталғаны туралы сізге хабар келеді. Оған дейін браузердің басқа бетінде ойнай берсеңіз болады.';

  @override
  String get arenaIsRated => 'Бұл бағаланатын жарыс, сіздің рейтингіңізге әсер етеді.';

  @override
  String get arenaIsNotRated => 'Бұл жарыс бағалы *емес*, сіздің рейтингіңізге әсер *етпейді*.';

  @override
  String get arenaSomeRated => 'Жарыстардың кейбірі бағалы, яғни рейтингке әсер етеді.';

  @override
  String get arenaHowAreScoresCalculated => 'Ұпай есептеу әдісі қандай?';

  @override
  String get arenaHowAreScoresCalculatedAnswer => 'Жеңіс 2 ұпай, тепе-теңдік 1 ұпай тұрады, ал жеңіліс үшін ұпай жоқ.\nЕгер сіз қатарынан екі ойын ұтсаңыз, сіз жалын суретімен белгіленген Қос ұпай жолына түсесіз.\nКелесі ойындар сіз жеңілгеніңізше қос еселі ұпай тұратын болады.\nЯғни, ұтыс – 4 ұпай, тепе-теңдік – 2 ұпай, ал жеңіліс үшін бұрынғыдай ұпай болмайды.\n\nМысалы, екі жеңістен кейін бір тепе-теңдік болса, қорытындысы 6 ұпай болады: 2 + 2 + (2 х 1)';

  @override
  String get arenaBerserk => 'Берсерк Алаңы';

  @override
  String get arenaBerserkAnswer => 'Ойын басында ойыншы Берсерк батырмасын басқан соң оның уақыты жартылай кемиді, бірақ ұтыс қосымша бір турнирлік ұпай әкеледі.\n\nУақыт қосылғышы бар ойындарда Берсерк бұл қосылғышты жояды (1+2 қалпы 1+0-ге айналады).\n\nНегізгі уақыты 0-ге тең ойындарда Берсерк болмайды (0+1, 0+2).\n\nСіз кем дегенде 7 жүріс жасасаңыз ғана Берсерк қосымша ұпай береді.';

  @override
  String get arenaHowIsTheWinnerDecided => 'Жеңімпазды қалай анықтайды?';
  ...
  @override
  String get arenaHowDoesItEnd => 'Қалай аяқталады?';

  @override
  String get arenaHowDoesItEndAnswer => 'Жарыстың шектелген бір ұзақтығы бар. Ол біткенде, орын үлестіру тоқталып, жеңімпаз жария болады. Ойналып жатқан ойындар аяғына дейін жетуі тиіс, бірақ нәтижеге әсері болмайды.';

  @override
  String get arenaOtherRules => 'Басқа маңызды ережелер';

  @override
  String get arenaThereIsACountdown => 'Бұл бірінші жүріске берілген уақыт санағышы. Осы уақытта жүріс жасалмаса, ойын қарсыластың пайдасына аяқталады.';

  @override
  String get arenaThisIsPrivate => 'Бұл оңаша жарыс';

  @override
  String arenaShareUrl(String param) {
    return 'Адамдар қосылсын десеңіз, осы URL-мен бөлісіңіз: $param';
  }

  @override
  String arenaDrawStreakStandard(String param) {
    return 'Тепе-теңдік тізбегі: егер Алаңда қатарынан бірнеше тепе-теңдік шықса, олардың арасынан ұпай беретіні –тек алғашқысы немесе $param жүрістен асқаны ғана. Тепе-теңдік тізбегін үзу үшін сізге тек жеңіс керек.';
  }

  @override
  String get arenaDrawStreakVariants => 'Ұпайға ие болу үшін тепе-теңдікпен аяқталған ойын ұзындығы. Төмендегі тізім әр шахмат түріне сәйкес осы межені көрсетеді.';

  @override
  String get arenaVariant => 'Шахмат түрі';

  @override
  String get arenaMinimumGameLength => 'Ойын ұзындығының кемі';

  @override
  String get arenaHistory => 'Алаң журналы';

  @override
  String get arenaNewTeamBattle => 'Жаңа Топтық Күрес';

  @override
  String get arenaCustomStartDate => 'Басталудың ерекше күні';

  @override
  String get arenaCustomStartDateHelp => 'Сіздің жергілікті уақыт белдеуіңіз. Бұл \"Жарысқа дейінгі уақыт\" баптауына әсер етеді';

  @override
  String get arenaAllowBerserk => 'Берсерк-ті рұқсат ету';

  @override
  String get arenaAllowBerserkHelp => 'Қосымша ұпай жинау үшін ойыншыларға уақытты жартылай қыстартуды рұқсат ету';

  @override
  String get arenaAllowChatHelp => 'Ойыншыларға чат бөлмесінде сөйлесуді рұқсат ету';

  @override
  String get arenaArenaStreaks => 'Алаң тізбектері';

  @override
  String get arenaArenaStreaksHelp => 'Қатарынан болған 2 жеңіс 2 ұпайдың орнына 4 ұпай тұрады.';

  @override
  String get arenaNoBerserkAllowed => 'Берсерк болмайды';

  @override
  String get arenaNoArenaStreaks => 'Алаң тізбектерін өшіру';

  @override
  String get arenaAveragePerformance => 'Орташа жетістік';

  @override
  String get arenaAverageScore => 'Орташа ұпай';

  @override
  String get arenaMyTournaments => 'Менің жарыстарым';

  @override
  String get arenaEditTournament => 'Жарысты өңдеу';
  ...
  @override
  String get arenaWhichTeamWillYouRepresentInThisBattle => 'Осы күресте қай топқа мүшесіз?';

  @override
  String get arenaYouMustJoinOneOfTheseTeamsToParticipate => 'Қатысу үшін осы топтардың біріне қосылуыңыз керек!';
  ...
  String arenaAllAveragesAreX(String param) {
    return 'Бұл беттегі барлық орташалар - $param.';
  }

  @override
  String get arenaTotal => 'Барлығы';

  @override
  String get arenaPointsAvg => 'Орташа ұпай';

  @override
  String get arenaPointsSum => 'Барлық ұпай';

  @override
  String get arenaRankAvg => 'Орын орташасы';

  @override
  String get arenaTournamentWinners => 'Жарыс жеңімпаздары';

  @override
  String get arenaTournamentShields => 'Жарыс қалқандары';

  @override
  String get arenaOnlyTitled => 'Тек атақты ойыншылар';

  @override
  String get arenaOnlyTitledHelp => 'Атақ болса ғана, қосылуға рұқсат';

  @override
  String get arenaTournamentPairingsAreNowClosed => 'Жарыстағы жұптасу аяқталды.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Ойынның алғашқы $count жүрісінде тепе-теңдік ешбір ойыншыға ұпай әкелмейді.',
      one: 'Ойынның алғашқы $count жүрісінде тепе-теңдік ешбір ойыншыға ұпай әкелмейді.',
    );
    return '$_temp0';
  }
  ...
  String arenaViewAllXTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Барлық $count топты қарау',
      one: 'Топты қарау',
    );
    return '$_temp0';
  }
  ...
  @override
  String get broadcastBroadcastCalendar => 'Көрсетілім күнтізбесі';

  @override
  String get broadcastNewBroadcast => 'Жаңа тікелей көрсетілім';

  @override
  String get broadcastSubscribedBroadcasts => 'Көрсетілім жазылымдары';

  @override
  String get broadcastAboutBroadcasts => 'Көрсетілім деген не?';

  @override
  String get broadcastHowToUseChessigmaBroadcasts => 'Личес Көрсетілімді қолдану жолы.';

  @override
  String get broadcastTheNewRoundHelp => 'Жаңа айналымда өткендегі сол мүше мен қолдаушылар болады.';
  ...
  @override
  String get broadcastSourceSingleUrl => 'PGN мекенжайы';

  @override
  String get broadcastSourceUrlHelp => 'PGN жаңартуларын алу үшін Личес тексеретін сілтеме. Ол интернетте баршалыққа ашық болуы керек.';
  ...
  @override
  String get challengeInviteChessigmaUser => 'Не Личес ойыншысын шақыру:';

  @override
  String get contactContact => 'Байланыс';

  @override
  String get contactContactChessigma => 'Личеспен байланыс';
  ...
  @override
  String get patronChessigmaPatron => 'Личес Қамқоршысы';
  ...
  @override
  String get puzzleThemeMixDescription => 'Барлығынан аз-аздан. Күтпеген жағдайларға бейім болыңыз! Дәл нағыз шахматтағыдай!';
  ...
  @override
  String get waitingForOpponent => 'Қарсыласты тосып тұрмыз';
  ...
  @override
  String get collapseVariations => 'Тармақтарды жабу';

  @override
  String get expandVariations => 'Тармақтарды ашу';
  ...
  @override
  String get copyMainLinePgn => 'Негізгі тарихтың PGN көшіру';
  ...
  @override
  String get computersAreNotAllowedToPlay => 'Компьютер көмегін пайдалану - тыйым. Ойын кезінде әр түрлі шахмат есептеуіштерін, дерекқорларын не басқа бір ойыншының көмегін қолданбаңыз. Сонымен қатар, бірнеше тіркелгі жасауды құптамаймыз, көп тіркелгі жасаушыға бұғау салынады.';
  ...
  @override
  String get otherPlayers => 'басқа ойыншылар';
  ...
  @override
  String get youAreLeavingChessigma => 'Сіз Личес-тен шыққалы тұрсыз';
  ...
  @override
  String get customPosition => 'Жеке орналасым';
  ...
  @override
  String get noNetwork => 'Желіден тыс';
  ...
  @override
  String get startingIn => 'Басталуы';
  ...
  @override
  String get drawRate => 'Теңдік үлесі';
  ...
  @override
  String get realName => 'Шын атыңыз';

  @override
  String get setFlair => 'Кейіпті таңдап алыңыз';

  @override
  String get flair => 'Кейпіңіз';

  @override
  String get youCanHideFlair => 'Керек десеңіз, бүкіл ойыншылардың Кейпін жасыру амалы бар.';

  @override
  String get biography => 'Өмірбаян';

  @override
  String get countryRegion => 'Ел мен аймағыңыз';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Личес ТВ-да көрсетілген';
  ...
  @override
  String get reportCheatBoostHelp => 'Ойын сілтемесін қойып, осы ойыншының қай әрекеті орынсыз болғанын түсіндіріп беріңіз. Жай ғана \"ол алдап ойнады\" демей, осы ойға қалай келгеніңізді айтып беріңіз.';
  ...
  @override
  String get allSquaresOfTheBoard => 'Әр шаршыда';
  ...
  @override
  String get keyNextBranch => 'Келесі тармақ';

  @override
  String get toggleVariationArrows => 'Тармақ нұсқағышты көрсету';

  @override
  String get cyclePreviousOrNextVariation => 'Алдынғы/келесі тармаққа өту';

  @override
  String get toggleGlyphAnnotations => 'Жүріс ескертпелерін көрсету';
  ...
  @override
  String get playSelectedMove => 'тандалған жүрісті ойнату';
  ...
  @override
  String get ifYouDoNotGetTheEmail => 'Егер 5 минутта поштаңызға хат келмесе:';

  @override
  String get checkAllEmailFolders => 'Спам, себет, басқа да қалталарды қарап шығыңыз';

  @override
  String verifyYourAddress(String param) {
    return '$param дұрыс жазылғанын тексеріңіз';
  }
  ...
  @override
  String get networkLagBetweenYouAndChessigma => 'Личес пен сіздің араңыздағы кідіріс';

  @override
  String get timeToProcessAMoveOnChessigmaServer => 'Личес сервердің жүрісті өңдеуге жұмсайтын уақыты';
  ...
  @override
  String get downloadAllGames => 'Барлық ойындарды жүктеп алу';
  ...
  @override
  String get waitingForAnalysis => 'Талдауды тосып тұрмыз';
  ...
  @override
  String get reopenYourAccountDescription => 'Тіркелгіңіз жабылғаннан кейін оны қайта ашқыңыз келсе, сізде бір қайталанбас амал бар.';
  ...
  @override
  String get streamerChessigmaStreamers => 'Личес стримерлері';
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Тек таныстарды әрі зерттеуге қосылуға шын ниетті адамдарды ғана шықырыңыз.';
  ...
  @override
  String get studyOnlyContributorsCanRequestAnalysis => 'Зерттеу қолдаушылары ғана компьютерлік талдауды сұрай алады.';

  @override
  String get studyGetAFullComputerAnalysis => 'Сервер-жақты компьютер осы негізгі жолға толық талдау жасайтын болады.';

  @override
  String get studyMakeSureTheChapterIsComplete => 'Талдауды бір рет қана сұрай аласыз, сондықтан бөлімді аяқтауды ұмытпаңыз.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition => 'Барлық үйлескен мүшелер өз күйінде қалады';

  @override
  String get studyShareChanges => 'Көрермендермен өзгертулерді бөлісіңіз әрі серверде сақтап қойыңыз';
  ...
  @override
  String get studyClearAllCommentsInThisChapter => 'Бөлімдегі бүкіл пікір, глиф пен сызбаларды өшіресіз бе?';
