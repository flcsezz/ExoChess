...
class AppLocalizationsHy extends AppLocalizations {
  ...
  String get puzzleFromMyGamesNone =>
      'Տվյալների բազայում Ձեր պարտիաներից խնդիրներ չկան, բայց Chessigma-ը Ձեզ հետ հույսեր է կապում։ Խաղացե՛ք ավելի շատ արագ կամ դասական ժամակարգով պարտիաներ, և խնդիրներ ունեցող խաղացողների ցանկում հայտնվելու Ձեր հնարավորությունները կմեծանան։';
  ...
  String get blankedPassword =>
      'Նույն գաղտնաբառը Դուք օգտագործել եք այլ կայքում, իսկ այդ կայքը վարկաբեկվել է։ Այժմ Chessigma-ի Ձեր մասնակցային հաշվի անվտանգության համար անհրաժեշտ է սահմանել նոր գաղտնաբառ։ Շնորհակալություն ըմբռնումով մոտենալու համար։';
  ...
  String get tournamentHomeDescription =>
      'Մրցաշարում խաղացե՜ք արագ շախմատ։ Ընտրեք Chessigma-ի պաշտոնական մրցաշարերից ցանկացածը կամ ստեղծեք ձերը։ Գնդակ (Bullet), կայծակնային (Blitz), դասական, շախմատ-960 (Ֆիշերի շախմատ, Chess960), արքան կենտրոնում (King of the Hill), երեք շախ (Threecheck) և խաղի այլ տարբերակներ. դրանք կապահովեն ձեր շախմատային հաճույքը։';
  ...
  String get networkLagBetweenYouAndChessigma =>
      'Ձեր և Chessigma-ի սերվերների միջև տվյալների փոխանցման հետաձգում:';
  ...
  String get lostAgainstTOSViolator =>
      'Դուք պարտվել եք նրան, ով խախտել է Chessigma-ի օգտվողի համաձայնագիրը';
  ...
  String get lichessPatronInfo =>
      'Chessigma-ը բարեգործական կազմակերպություն է, որը տրամադրում է բաց նախնական կոդով ազատ և անվճար ծրագրային ապահովում։\nՕպերացիոն բոլոր ծախսերը, մշակումները և կոնտենտը ֆինանսավորվում են բացառապես օգտատերերի նվիրաբերությունների հաշվին։';
  ...
  String get studyYouCanPasteThisInTheForumToEmbed =>
      'Ֆորումում կամ Chessigma-ի բլոգում ներդնելու համար տեղադրեք այս կոդը';
