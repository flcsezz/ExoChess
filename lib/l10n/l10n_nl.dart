...
class AppLocalizationsNl extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Deze voorkeuren worden toegepast op je Chessigma account en worden op alle apparaten gebruikt.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Houd er rekening mee dat niet alle functies van de oude app of website beschikbaar zijn, maar we voegen voortdurend functies toe.';
  ...
  String get mobileSettingsImmersiveModeSubtitle =>
      'Systeem-UI verbergen tijdens het spelen. Gebruik dit als je last hebt van de navigatiegebaren aan de randen van het scherm. Van toepassing bij partijen en puzzels.';
  ...
  String get mobileSettingsPickAnImageHelp =>
      'Aangepaste achtergrond werkt alleen in donkere modus. Een donkere afbeelding wordt aanbevolen.';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Maak vormen door twee vingers te gebruiken: Houd één vinger op een leeg vakje en sleep een andere vinger om een vorm te tekenen.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Wanneer ingeschakeld, zal het apparaat kort trillen wanneer je een stuk verplaatst of slaat.';
  ...
  @override
  String get mobileWelcomeToChessigmaApp => 'Welkom bij de Chessigma app!';
  ...
  String get mobileCustomizeHomeTip =>
      'Tip: je kunt meer widgets toevoegen aan het startscherm of widgets verwijderen die je niet nodig hebt!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Openingsverkenner is niet offline beschikbaar.';

  @override
  String get mobileChallengeCreated =>
      'Uitdaging gemaakt: je krijgt bericht wanneer de partij begint.\\nJe kunt de partij vanaf je home-tabblad openen.';
  ...
  String get variantChess960Title =>
      'De beginopstelling van de stukken op de eerste rij worden willekeurig bepaald.';
  ...
  String get variantHordeTitle =>
      'De ene kant heeft een groot aantal pionnen, de andere speelt met normale stukken.';

  @override
  String get variantRacingKingsTitle =>
      'Breng je koning naar de andere kant van het bord om te winnen.';

  @override
  String get variantCrazyhouseTitle =>
      'Geslagen stukken kunnen terug op het bord worden geplaatst in plaats van dat ze verzet worden.';
  ...
  @override
  String get broadcastHowToUseChessigmaBroadcasts => 'Hoe Chessigma Uitzendingen te gebruiken.';
  ...
  String get broadcastSourceUrlHelp =>
      'Link die Chessigma gebruikt om PGN updates te krijgen. Deze moet openbaar toegankelijk zijn via internet.';

  @override
  String get broadcastSourceGameIds => 'Tot 64 Chessigma partij-ID\'\'s, gescheiden door spaties.';
  ...
  @override
  String get broadcastOpenChessigma => 'Openen in Chessigma';
  ...
  String get broadcastStandingsDisclaimer =>
      'Standen worden berekend aan de hand van uitgezonden partijen en kunnen verschillen van de officiële resultaten.';
  ...
  String broadcastTermsAutomaticallyTranslated(String param) {
    return 'De volgende termen worden automatisch vertaald: $param.';
  }
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Laat de standaardnaam intact voor automatische vertaling naar alle andere talen.';

  @override
  String get broadcastOpenTournament => 'Open';

  @override
  String get broadcastWomenTournament => 'Dames';

  @override
  String get broadcastMenTournament => 'Heren';

  @override
  String get broadcastGirlsTournament => 'Meiden';

  @override
  String get broadcastBoysTournament => 'Jongens';
  ...
  String broadcastGirlsUnderXAgeTournament(String param) {
    return 'Meiden O$param';
  }

  @override
  String broadcastBoysUnderXAgeTournament(String param) {
    return 'Jongens O$param';
  }

  @override
  String get broadcastQuarterfinals => 'Kwartfinales';

  @override
  String get broadcastSemifinals => 'Halve finales';
  ...
  @override
  String get challengeInviteChessigmaUser => 'Of nodig een Chessigma-gebruiker uit:';

  @override
  String get contactContact => 'Contact';

  @override
  String get contactContactChessigma => 'Contact met Chessigma';
  ...
  @override
  String get patronChessigmaPatron => 'Chessigma Patroon';

  @override
  String get patronBecomePatron => 'Word een Chessigma Patroon';
  ...
  @override
  String get preferencesNotifyBell => 'Bel melding binnen Chessigma';

  @override
  String get preferencesNotifyPush => 'Apparaatmelding wanneer je niet op Chessigma bent';
  ...
  String get puzzleThemeBalestraMateDescription =>
      'Een loper zet mat waarbij een dame de resterende vluchtvelden blokkeert';
  ...
  String get puzzleThemeBlindSwineMateDescription =>
      'Twee torens werken samen om de koning mat te zetten in een 2x2-vierkant.';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      'Twee vijandige stukken staan tegenover elkaar, en één glipt langs de lijn van aanval zonder het stuk van de vijand te slaan.';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Dring de koning met behulp van een toren of dame en een paard een hoek in om hem schaakmat te zetten.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'Een stuk verplaatsen om schaak te geven met een verborgen aanvalsstuk, wat vaak leidt tot beslissend voordeel.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Twee aangrenzende ontsnappingsvakjes voor een koning in schaak worden bezet door andere stukken.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'De toren geeft mat, terwijl de loper helpt met opsluiten.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Gebruik de loper om de koning te mat te zetten, terwijl je toren helpt om hem te de pas af te snijden.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Een matpatroon dat visueel lijkt op de staart van een zwaluw, zoals de vorm van een V.';
  ...
  String get puzzleThemeTriangleMateDescription =>
      'De toren en koningin, een vakje verwijderd van de vijandelijke koning, staan op dezelfde rij of kolom, gescheiden door een vakje, en vormen samen een driehoek.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Zet de koning mat met een toren en gebruik een loper om de toren te verdedigen.';
  ...
  @override
  String get challengeAFriend => 'Daag een vriend uit';

  @override
  String get playAgainstComputer => 'Speel tegen de computer';
  ...
  @override
  String get reusableChallengeUrl => 'Herbruikbare URL';

  @override
  String get permanentLinkForAnyoneToChallengeYou =>
      'Een permanente link voor iedereen om je uit te dagen met exact deze instellingen.';
  ...
  @override
  String get undefendedPieces => 'Onverdedigde stukken';

  @override
  String get pinnedPieces => 'Gepende stukken';

  @override
  String get checkableKing => 'Schaakbare koning';
  ...
  String get multipleLinesDescription =>
      'Stel het aantal evaluatievariaties en zetpijlen in op het bord';
  ...
  String get threadsDescription =>
      'Stel dit in onder het aantal threads van uw CVE, de pijltjes markeren een goede veilige keuze';

  @override
  String get threadsDescriptionMobile =>
      'Meer threads zullen meer accu gebruiken voor een betere analyse';
  ...
  String get signupEmailPromise =>
      'We sturen alleen e-mails over uw account en delen uw e-mail nooit.';
  ...
  String get blankedPassword =>
      'Je hebt hetzelfde wachtwoord gebruikt op een andere site en die site heeft een datalek gehad. Om de veiligheid van je Chessigma-account te garanderen, dien je een nieuw wachtwoord in te stellen. Bedankt voor je begrip.';

  @override
  String get youAreLeavingChessigma => 'Je verlaat Chessigma';

  @override
  String get neverTypeYourPassword =>
      'Voer je Chessigma-wachtwoord nooit in op een andere website!';
  ...
  String get thisAccountViolatedTos =>
      'Dit account heeft de Chessigma Servicevoorwaarden geschonden';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      'Raitingfilters zijn vergrendeld omdat je rating niet stabiel is. Het spelen van partijen met rating zal de stabiliteit vergroten.';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Voorheen op Chessigma TV';
  ...
  @override
  String get lichessTournaments => 'Chessigma toernooien';
  ...
  @override
  String get networkLagBetweenYouAndChessigma => 'Netwerkvertraging tussen u en Chessigma';
  ...
  String get primaryColorArrowsHowTo =>
      'Ctrl of shift = rood; command, alt, of meta-toets = blauw; allen tegelijk = geel.';
  ...
  String inKidModeTheChessigmaLogoGetsIconX(String param) {
    return 'In kindvriendelijke modus, krijgt het Chessigma-logo een $param-icoontje, zodat je weet dat je kinderen veilig zijn.';
  }
  ...
  @override
  String get showUnreadChessigmaMessage => 'Je hebt een privébericht van Chessigma ontvangen.';
  ...
  @override
  String get agreementPolicy => 'Ik ga ermee akkoord dat ik de Chessigma-regels zal volgen.';
  ...
  String get lostAgainstTOSViolator =>
      'Je hebt verloren van iemand die de Chessigma voorwaarden heeft geschonden';
  ...
  @override
  String get lichessDbExplanation => 'Partijen met rating gespeeld op Chessigma';
  ...
  @override
  String get streamerChessigmaStreamers => 'Chessigma streamers';
  ...
  @override
  String get studyCopyRawChapterPgn => 'Kale pgn kopiëren';
  ...
  String get studyClearAllCommentsInThisChapter =>
      'Wis alle opmerkingen, glyphs en getekende vormen in dit hoofdstuk';
  ...
  @override
  String get studyWelcomeToChessigmaStudyTitle => 'Welkom bij Chessigma Study!';
  ...
  String get studyConclusionText =>
      'Je kunt je <a href=\'/studie/mine/hot\'>vorige studies</a> vinden op je profielpagina.<br>Er is ook een <a href=\'//lichess.org/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way\'>blogpost over studies</a>.<br>Power users kunnen op \"?\" drukken om sneltoetsen te zien.<br>Veel plezier!';
  ...
  String get studyFromInitialPositionText =>
      'Gewoon een bord voor een nieuwe partij.<br>Geschikt om openingen te verkennen.';
  ...
  String get studyCustomPositionText =>
      'Richt het bord op jouw manier in <br>Geschikt om eindspellen te verkennen.';

  @override
  String get studyLoadExistingChessigmaGameTitle => 'Laad een bestaande lichess-partij';
  ...
  String get studyVariantsAreSupportedText =>
      'Ja, je kunt crazyhouse<br>en alle lichess-varianten bestuderen!';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Plak hier spellen als PGN-tekst. Voor elk spel wordt een nieuw hoofdstuk gemaakt. De studie kan maximaal $count hoofdstukken hebben.',
