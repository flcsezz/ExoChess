...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get mobileAccountPreferencesHelp => 'Estas preferências são aplicadas à sua conta Chessigma e serão usadas em todos os dispositivos.';
  ...
  @override
  String get mobilePuzzleStormFilterNothingToShow => 'Nada para mostrar, por favor, altera os filtros';
  ...
  @override
  String get mobilePuzzleStreakAbortWarning => 'Perderas a tua sequência atual e a pontuação será salva.';
  ...
  @override
  String get mobileSettingsPickAnImageShowBoard => 'Mostrar tabuleiro';

  @override
  String get mobileSettingsPickAnImageSwipeToDisplay => 'Deslize para mostrar outros fundos';

  @override
  String get mobileSettingsPieceShiftMethodEither => 'Clica ou arrasta';
  ...
  @override
  String get mobileSettingsShapeDrawingSubtitle => 'Desenha formas usando dois dedos: mantém um dedo num quadrado livre e arrasta o outro dedo para criares uma forma.';
  ...
  @override
  String get mobileWelcomeToChessigmaApp => 'Bem-vindo(a) à aplicação do Chessigma!';
  ...
  @override
  String get arenaArenaTournaments => 'Torneios em arena';

  @override
  String get arenaIsItRated => 'É por pontos?';

  @override
  String get arenaWillBeNotified => 'Serás notificado quando o torneio começar, por isso é seguro jogares noutro separador enquanto esperas.';

  @override
  String get arenaIsRated => 'Este torneio é por pontos e afetará a tua pontuação.';

  @override
  String get arenaIsNotRated => 'Este torneio *não* é por pontos e *não* afetará a tua pontuação.';
  ...
  @override
  String get arenaHowDoesItEndAnswer => 'O torneio tem um relógio de contagem decrescente. Quando chega a zero, as classificações do torneio são congeladas, e o vencedor é anunciado. Os jogos a decorrer têm de ser terminados, contudo, estes não contam para o torneio.';

  @override
  String get arenaOtherRules => 'Outras regras importantes';

  @override
  String get arenaThereIsACountdown => 'Existe um tempo limite para a primeira jogada. Se um jogador não a fizer dentro deste tempo, a vitória irá para o seu adversário.';

  @override
  String get arenaThisIsPrivate => 'Este é um torneio privado';

  @override
  String arenaShareUrl(String param) {
    return 'Partilha este link para que as pessoas possam entrar: $param';
  }

  @override
  String arenaDrawStreakStandard(String param) {
    return 'Sequência de empates: Quando um jogador tem empates consecutivos numa arena, apenas o primeiro empate ou os empates que duraram mais de $param movimentos resultarão num ponto. A sequência de empates só pode ser quebrada por uma vitória, não por uma derrota ou empate.';
  }

  @override
  String get arenaDrawStreakVariants => 'A duração mínima do jogo para empates difere por variante. A tabela abaixo lista o limite para cada variante.';

  @override
  String get arenaVariant => 'Variante';

  @override
  String get arenaMinimumGameLength => 'Duração mínima do jogo';

  @override
  String get arenaHistory => 'Histórico de arenas';

  @override
  String get arenaNewTeamBattle => 'Batalha de Equipas';

  @override
  String get arenaCustomStartDate => 'Data inicial personalizada';

  @override
  String get arenaCustomStartDateHelp => 'No seu próprio fuso horário local. Substitui a configuração \"Tempo antes do torneio começar\"';

  @override
  String get arenaAllowBerserk => 'Permitir Berserk';

  @override
  String get arenaAllowBerserkHelp => 'Permitir aos jogadores ganhar um ponto extra ao reduzir a duração do relógio a metade';

  @override
  String get arenaAllowChatHelp => 'Permitir que os jogadores discutam numa sala de bate-papo';

  @override
  String get arenaArenaStreaks => 'Séries de Arena';

  @override
  String get arenaArenaStreaksHelp => 'Depois de 2 vitórias, vitórias consecutivas concedem 4 pontos em vez de 2.';

  @override
  String get arenaNoBerserkAllowed => 'Não são permitidos Berserk';

  @override
  String get arenaNoArenaStreaks => 'Sem Séries de Arena';

  @override
  String get arenaAveragePerformance => 'Desempenho médio';

  @override
  String get arenaAverageScore => 'Pontuação média';

  @override
  String get arenaMyTournaments => 'Os meus torneios';

  @override
  String get arenaEditTournament => 'Editar torneio';
  ...
  @override
  String get arenaRecentlyPlayed => 'Jogado recentemente';

  @override
  String get arenaBestResults => 'Melhores resultados';
  ...
  String arenaAllAveragesAreX(String param) {
    return 'Todas as médias desta página são $param.';
  }
  ...
  @override
  String get arenaPointsAvg => 'Média de pontos';

  @override
  String get arenaPointsSum => 'Pontos Somados';

  @override
  String get arenaRankAvg => 'Classificação Média';

  @override
  String get arenaTournamentWinners => 'Vencedores do torneio';

  @override
  String get arenaTournamentShields => 'Escudos do torneio';

  @override
  String get arenaOnlyTitled => 'Apenas jogadores titulados';

  @override
  String get arenaOnlyTitledHelp => 'Exigir um título oficial para entrar no torneio';

  @override
  String get arenaTournamentPairingsAreNowClosed => 'Os emparelhamentos no torneio já estão fechados.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Ao empatar o jogo nas primeiras $count jogadas, nenhum dos jogadores ganha pontos.',
      one: 'Ao empatar o jogo na primeira jogada, nenhum dos jogadores ganha pontos.',
    );
    return '$_temp0';
  }
  ...
  String arenaViewAllXTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Ver todas as $count equipas',
      one: 'Ver a equipa',
    );
    return '$_temp0';
  }
  ...
  @override
  String get broadcastHowToUseChessigmaBroadcasts => 'Como usar as Transmissões do Chessigma.';

  @override
  String get broadcastTheNewRoundHelp => 'A nova ronda terá os mesmos membros e contribuidores que a anterior.';
  ...
  @override
  String get broadcastSourceUrlHelp => 'Link que o Chessigma vai verificar para obter atualizações da PGN. Deve ser acessível ao público a partir da internet.';

  @override
  String get broadcastSourceGameIds => 'Até 64 IDs de jogo Chessigma, separados por espaços.';
  ...
  @override
  String get broadcastReplacePlayerTags => 'Opcional: substituir nomes de jogadores, avaliações e títulos';
  ...
  @override
  String get broadcastOpenChessigma => 'Abrir no Chessigma';
  ...
  @override
  String get broadcastSubscribeTitle => 'Subscreva para ser notificado quando cada ronda começar. Podes ativar o sino ou as notificações push para transmissões nas preferências da tua conta.';
  ...
  @override
  String get broadcastSinceHideResults => 'Como optastes por ocultar os resultados, todas as pré-visualizações dos tabuleiros estão vazias para evitar spoilers.';
  ...
  @override
  String get challengeInviteChessigmaUser => 'Ou convide um utilizador Chessigma:';

  @override
  String get contactContact => 'Contacto';

  @override
  String get contactContactChessigma => 'Contactar o Chessigma';
  ...
  @override
  String get coordinatesKnowingTheChessBoard => 'Saber as coordenadas do tabuleiro é uma habilidade muito importante no xadrez:';

  @override
  String get coordinatesMostChessCourses => 'A maioria dos cursos e exercícios usam extensamente a notação algébrica.';

  @override
  String get coordinatesTalkToYourChessFriends => 'Torna-se mais fácil falar de xadrez com os teus amigos, já que ambos entendem o \"idioma do xadrez\".';

  @override
  String get coordinatesYouCanAnalyseAGameMoreEffectively => 'Podes analisar um jogo com maior eficiência se conseguires reconhecer as coordenadas rapidamente.';

  @override
  String get coordinatesACoordinateAppears => 'Aparece uma coordenada no tabuleiro e deve clicar no quadrado correspondente.';

  @override
  String get coordinatesASquareIsHighlightedExplanation => 'É destacado um quadrado no tabuleiro e deve introduzir a sua coordenada (ex: \"e4\").';

  @override
  String get coordinatesYouHaveThirtySeconds => 'Tem 30 segundos para mapear corretamente o máximo de quadrados possível!';

  @override
  String get coordinatesGoAsLongAsYouWant => 'Pode continuar enquanto quiser, não há limite de tempo!';
  ...
  @override
  String get patronChessigmaPatron => 'Patrono do Chessigma';

  @override
  String get patronBecomePatron => 'Tornar-se um patrono do Chessigma';
  ...
  @override
  String get preferencesNotifyBroadcasts => 'Transmissões que você se inscreveu';

  @override
  String get preferencesNotifyTimeAlarm => 'Está a acabar o tempo no jogo por correspondência';

  @override
  String get preferencesNotifyBell => 'Notificação do sino no Chessigma';

  @override
  String get preferencesNotifyPush => 'Notificação do dispositivo quando não está no Chessigma';
  ...
  @override
  String get preferencesShowClockOnTheLeft => 'Exiba à esquerda nos dispositivos móveis';
  ...
  String puzzlePuzzlesFoundInUserGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count problemas encontrados no jogos de $param2',
      one: 'Um problema encontrado nos jogos de $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get puzzleThemeVukovicMateDescription => 'Uma torre e um cavalo juntam-se para dar xeque-mate ao rei. A torre dá mate apoiada por uma terceira peça, e o cavalo é utilizado para bloquear as casas de fuga do rei.';
  ...
  @override
  String get puzzleThemeOperaMateDescription => 'Xeque o rei com a torre e use o bispo para defender a torre.';
  ...
  @override
  String get puzzleThemeMixDescription => 'Um pouco de tudo. Não sabes o que esperar, então ficas pronto para qualquer coisa! Exatamente como em jogos de verdade.';
  ...
  @override
  String get settingsCantOpenSimilarAccount => 'O nome de utilizador NÃO estará disponível para registo novamente.';
  ...
  @override
  String get challengeAFriend => 'Desafiar um Amigo';

  @override
  String get playAgainstComputer => 'Jogar contra o computador';

  @override
  String get gameMode => 'Modo de jogo';

  @override
  String get createLobbyGame => 'Criar jogo no lobby';
  ...
  @override
  String get createTheGame => 'Criar partida';
  ...
  @override
  String get copyMainLinePgn => 'Copiar linha principal do PGN';
  ...
  @override
  String get drawClaimed => 'Empate reivindicado';
  ...
  @override
  String get blankedPassword => 'Utilizou a mesma palavra-passe noutro site, e esse site foi comprometido. Para garantir a segurança da sua conta Chessigma, precisamos que redefina a palavra-passe. Obrigado pela compreensão.';

  @override
  String get youAreLeavingChessigma => 'Você está a sair do Chessigma';

  @override
  String get neverTypeYourPassword => 'Nunca escrevas a tua senha Chessigma em outro site!';
  ...
  @override
  String get ratingFilter => 'Filtro de Rating';

  @override
  String get thisAccountViolatedTos => 'Esta conta violou os termos de serviço do Chessigma';
  ...
  @override
  String get whiteProposesTakeback => 'Brancas propõe voltar uma jogada atrás';

  @override
  String get blackProposesTakeback => 'Pretas propõe voltar uma jogada atrás';

  @override
  String get takebackPropositionSent => 'Proposta de voltar uma jogada atrás enviada';

  @override
  String get whiteDeclinesTakeback => 'Brancas negaram voltar uma jogada atrás';

  @override
  String get blackDeclinesTakeback => 'Pretas negaram voltar uma jogada atrás';

  @override
  String get whiteAcceptsTakeback => 'Brancas aceitaram voltar uma jogada atrás';

  @override
  String get blackAcceptsTakeback => 'Pretas aceitaram voltar uma jogada atrás';

  @override
  String get whiteCancelsTakeback => 'Brancas cancelaram voltar uma jogada atrás';

  @override
  String get blackCancelsTakeback => 'Pretas cancelaram voltar uma jogada atrás';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Anteriormente na TV Chessigma';
  ...
  @override
  String get reportCheatBoostHelp => 'Cola o(s) link(s) do(s) jogo(s) e explica o que está errado no comportamento deste utilizador. Não digas apenas “eles fazem batota”, mas diz-nos como chegaste a essa conclusão.';
  ...
  @override
  String get titleVerification => 'Verificação de título';
  ...
  @override
  String get lichessTournaments => 'Torneios do Chessigma';
  ...
  @override
  String get ifYouDoNotGetTheEmail => 'Se não receberes o e-mail dentro de 5 minutos:';

  @override
  String get checkAllEmailFolders => 'Verifica as pastas de lixo, spam e as outras';

  @override
  String verifyYourAddress(String param) {
    return 'Verifica se $param é teu endereço de email';
  }
  ...
  @override
  String get networkLagBetweenYouAndChessigma => 'Atraso na rede entre ti e o Chessigma';

  @override
  String get timeToProcessAMoveOnChessigmaServer => 'Tempo para processar um movimento no servidor do Chessigma';
  ...
  @override
  String get downloadAllGames => 'Descarregar todos os jogos';
  ...
  String inKidModeTheChessigmaLogoGetsIconX(String param) {
    return 'No modo criança, o logótipo do Chessigma fica com um ícone $param para que saibas que as tuas crianças estão seguras.';
  }
  ...
  String challengeX(String param) {
    return 'Desafiar $param';
  }

  @override
  String get showUnreadChessigmaMessage => 'Recebestes uma mensagem privada do Chessigma.';
  ...
  @override
  String get agreementPolicy => 'Concordo que seguirei todas as políticas do Chessigma.';
  ...
  @override
  String get lostAgainstTOSViolator => 'Perdeste pontos de classificação para alguém que violou as regras do Chessigma';
  ...
  @override
  String get reopenYourAccountDescription => 'Se fechares a tua conta, mas mudares de ideias, tens uma hipótese de recuperá-la.';
  ...
  @override
  String get lichessDbExplanation => 'Jogos avaliados por amostragem de todos os jogadores Chessigma';
  ...
  @override
  String get lichessPatronInfo => 'Chessigma é uma instituição de caridade e software de código aberto totalmente livre.\nTodos os custos operacionais, de desenvolvimento e conteúdo são financiados exclusivamente por doações de usuários.';
  ...
  @override
  String get enableBlindMode => 'Ativar o modo cego';
  ...
  @override
  String get streamerChessigmaStreamers => 'Streamers no Chessigma';
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Por favor, convida apenas pessoas que conheças e que querem participar ativamente neste estudo.';
  ...
  @override
  String get studyTheChapterIsTooShortToBeAnalysed => 'O capítulo é demasiado curto para ser analisado.';

  @override
  String get studyOnlyContributorsCanRequestAnalysis => 'Apenas os colaboradores de estudo podem solicitar uma análise de computador.';

  @override
  String get studyGetAFullComputerAnalysis => 'Obtém uma análise completa da linha principal pelo servidor.';

  @override
  String get studyMakeSureTheChapterIsComplete => 'Certifica-te que o capítulo está completo. Só podes solicitar a análise uma vez.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition => 'Todos os membros do SYNC permanecem na mesma posição';
  ...
  @override
  String get studyCopyRawChapterPgn => 'Copiar PGN bruto';
  ...
  @override
  String get studyOnlyPublicStudiesCanBeEmbedded => 'Só estudos públicos é que podem ser incorporados!';
  ...
  @override
  String get studyClearAllCommentsInThisChapter => 'Apagar todos os comentários e símbolos após lances neste capítulo?';
  ...
  @override
  String get studyDeleteTheStudyChatHistory => 'Apagar o histórico do chat do estudo? Não há volta atrás!';
  ...
  @override
  String get studyGetTheTour => 'Precisas de ajuda? Obter uma visita guiada!';

  @override
  String get studyWelcomeToChessigmaStudyTitle => 'Bem-vindo ao Estudo Chessigma!';

  @override
  String get studyWelcomeToChessigmaStudyText => 'Este é um tabuleiro de análise partilhado.<br><br>Utilize-o para analisar e anotar jogos,<br>discutir posições com amigos,<br>e, claro, para lições de xadrez!<br><br>É uma ferramenta poderosa, vamos tirar algum tempo para ver como funciona.';

  @override
  String get studySharedAndSaveTitle => 'Partilhado e salvado';

  @override
  String get studySharedAndSavedText => 'Outros membros podem ver as suas jogadas em tempo real! <br>Além disso, tudo é guardado para sempre.';
  ...
  String studyStudyMembersText(String param1, String param2) {
    return '$param1 Os espetadores podem ver o estudo e falar no chat.<br><br>$param2 Os contribuidores podem fazer movimentos e atualizar o estudo.';
  }

  @override
  String studyAddMembersText(String param) {
    return 'Clica no botão $param.<br>Depois, decide quem pode contribuir ou não.';
  }
  ...
  @override
  String get studyStudyChaptersText => 'Um estudo pode conter vários capítulos.<br> Cada capítulo tem uma posição inicial distinta e uma árvore de movimentos.';

  @override
  String get studyCommentPositionTitle => 'Comentar em uma posição';

  @override
  String studyCommentPositionText(String param) {
    return 'Clica no botão $param, ou faz um clique no lado direito do rato na lista de movimentos à direita.<br> Os comentários são partilhados e salvos.';
  }

  @override
  String get studyAnnotatePositionTitle => 'Anota uma posição';

  @override
  String get studyAnnotatePositionText => 'Clica no botão !?, ou faz um clique no lado direito do rato sobre a lista de movimentos à direita.<br> Glifos de anotação são partilhados e salvos.';

  @override
  String get studyConclusionTitle => 'Obrigado pelo seu tempo';

  @override
  String get studyConclusionText => 'Podes encontrar os teus <a href=\'/study/mine/hot\'> estudos prévios</a> a partir da tua página de perfil.<br> Também há uma <a href=\'//lichess.org/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way\'> publicação no blog sobre estudos</a>.<br> Utilizadores avançados podem querer pressionar \"?\" para ver os atalhos do teclado.<br> Divirta-te!';

  @override
  String get studyCreateChapterTitle => 'Vamos criar um capítulo de estudo';

  @override
  String get studyCreateChapterText => 'Um estudo pode ter vários capítulos.<br> Cada capítulo tem uma árvore de movimentos distinta,<br> e pode ser criado de diversas formas.';

  @override
  String get studyFromInitialPositionTitle => 'A partir da posição inicial';

  @override
  String get studyFromInitialPositionText => 'Apenas uma configuração de tabuleiro para um novo jogo.<br> Adequado para explorar aberturas.';

  @override
  String get studyCustomPositionTitle => 'Posição personalizada';

  @override
  String get studyCustomPositionText => 'Configura o tabuleiro à tua maneira.<br> Adequado para explorar finais de jogos.';

  @override
  String get studyLoadExistingChessigmaGameTitle => 'Carregar um jogo lichess existente';

  @override
  String get studyLoadExistingChessigmaGameText => 'Copia um URL de um jogo de lichess<br>(como lichess.org/7fHIU0XI)<br>para carregar os movimentos do jogo no capítulo.';

  @override
  String get studyFromFenStringTitle => 'A partir de uma string FEN';

  @override
  String get studyFromFenStringText => 'Cola uma posição em formato FEN<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>para começar o capítulo a partir de uma posição.';

  @override
  String get studyFromPgnGameTitle => 'De um jogo em PGN';

  @override
  String get studyFromPgnGameText => 'Cola um jogo em formato PGN.<br>para carregar movimentos, comentários e variações no capítulo.';

  @override
  String get studyVariantsAreSupportedTitle => 'Estudos suportam variantes';

  @override
  String get studyVariantsAreSupportedText => 'Sim, podes estudar crazyhouse<br>e todas as variantes do Chessigma!';

  @override
  String get studyChapterConclusionText => 'Capítulos são salvos permanentemente.<br>Diverte a organizar o teu conteúdo de xadrez!';

  @override
  String get studyDoubleDefeat => 'Derrota dupla';

  @override
  String get studyBlackDefeatWhiteCanNotWin => 'Pretas perderam, mas Brancas não podem vencer';

  @override
  String get studyWhiteDefeatBlackCanNotWin => 'Brancas perderam, mas Pretas não podem vencer';
...
class AppLocalizationsPtBr extends AppLocalizationsPt {
  ...
  @override
  String get mobileAccountPreferencesHelp => 'Essas preferências são aplicadas à sua conta Chessigma e serão usadas em todos os dispositivos.';
  ...
  @override
  String get mobileLiveStreamers => 'Streamers do Chessigma';
  ...
  @override
  String get mobileSettingsShapeDrawingSubtitle => 'Desenhe formas usando dois dedos: mantenha um dedo em uma casa vazia e arraste outro dedo para desenhar uma forma.';
  ...
  @override
  String get mobileWelcomeToChessigmaApp => 'Bem-vindo ao aplicativo Chessigma!';
  ...
  @override
  String get arenaArenaTournaments => 'Torneios de arena';

  @override
  String get arenaIsItRated => 'Valendo pontos?';

  @override
  String get arenaWillBeNotified => 'Você será notificado quando o torneio começar, portanto, é seguro jogar em outra aba enquanto espera.';

  @override
  String get arenaIsRated => 'Este torneio vale rating e irá afetar o seu rating.';

  @override
  String get arenaIsNotRated => 'Este torneio *não* está valendo pontos e *não* afetará seu rating.';

  @override
  String get arenaSomeRated => 'Alguns torneios valem pontos e afetarão seu rating.';
  ...
  @override
  String get arenaHowDoesItEndAnswer => 'O torneio tem um relógio de contagem regressiva. Quando ele chega a zero, as classificações do torneio são congeladas, e o vencedor é anunciado. Jogos em andamento devem ser finalizados, no entanto, eles não contam para o torneio.';

  @override
  String get arenaOtherRules => 'Outras regras importantes';

  @override
  String get arenaThereIsACountdown => 'Existe um tempo limite para a sua primeira jogada. Não realizá-la no período determinado significará uma vitória para o seu oponente.';
  ...
  @override
  String arenaShareUrl(String param) {
    return 'Compartilhe este endereço para permitir que outras pessoas entrem: $param';
  }

  @override
  String arenaDrawStreakStandard(String param) {
    return 'Sequência de empate: se um jogador tiver empates consecutivos num torneio de arena, ou empates que ocorrerem após $param lances em partidas normais, apenas o primeiro conta pontos. A única maneira de interromper essa sequência é com uma vitória.';
  }

  @override
  String get arenaDrawStreakVariants => 'O número mínimo de lances, para que se ganhe pontos com empates, difere por variante. A tabela abaixo mostra os valores mínimos para cada uma.';

  @override
  String get arenaVariant => 'Variante';

  @override
  String get arenaMinimumGameLength => 'Número mínimo de lances';

  @override
  String get arenaHistory => 'Histórico de arenas';

  @override
  String get arenaNewTeamBattle => 'Nova batalha de equipes';

  @override
  String get arenaCustomStartDate => 'Mudar a data de início';

  @override
  String get arenaCustomStartDateHelp => 'No seu próprio fuso horário. Isso irá cancelar a configuração \"Contagem regressiva para início do torneio\"';

  @override
  String get arenaAllowBerserk => 'Permitir Berserk';

  @override
  String get arenaAllowBerserkHelp => 'Os jogadores poderão reduzir seu tempo pela metade para ganhar um ponto extra';

  @override
  String get arenaAllowChatHelp => 'Permite que os jogadores discutam em uma sala de chat';

  @override
  String get arenaArenaStreaks => 'Sequências de vitória em arena';

  @override
  String get arenaArenaStreaksHelp => 'Após ganhar 2 partidas, vitórias consecutivas valem 4 pontos, ao invés de 2.';

  @override
  String get arenaNoBerserkAllowed => 'Não é permitido Berserk';

  @override
  String get arenaNoArenaStreaks => 'Sem sequências de vitória em arena';
  ...
  @override
  String get arenaMyTournaments => 'Meus torneios';
  ...
  @override
  String get arenaWhichTeamWillYouRepresentInThisBattle => 'Qual equipe você representará nesta batalha?';

  @override
  String get arenaYouMustJoinOneOfTheseTeamsToParticipate => 'Você deve se juntar a uma destas equipes para participar!';

  @override
  String get arenaCreated => 'Criado';

  @override
  String get arenaRecentlyPlayed => 'Jogados recentemente';
  ...
  @override
  String get arenaPointsSum => 'Soma dos pontos';

  @override
  String get arenaRankAvg => 'Média de classificação';

  @override
  String get arenaTournamentWinners => 'Vencedores de torneio';

  @override
  String get arenaTournamentShields => 'Torneios de escudo';
  ...
  @override
  String get arenaTournamentPairingsAreNowClosed => 'Os pareamentos do torneio fecharam.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Empatar o jogo nos primeiros $count lances não dará ponto a nenhum dos jogadores.',
      one: 'Empatar o jogo no primeiro $count lance não dará ponto a nenhum dos jogadores.',
    );
    return '$_temp0';
  }
  ...
  String arenaViewAllXTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Ver todas as $count equipes',
      one: 'Ver a equipe',
    );
    return '$_temp0';
  }
  ...
  @override
  String get broadcastSourceUrlHelp => 'URL que Chessigma irá verificar para obter atualizações PGN. Deve ser acessível ao público a partir da Internet.';

  @override
  String get broadcastSourceGameIds => 'Até 64 IDs de partidas do Chessigma, separados por espaços.';
  ...
  @override
  String get broadcastReplacePlayerTags => 'Opcional: substituir nomes de jogador, ratings e títulos';
  ...
  @override
  String get broadcastSubscribeTitle => 'Inscreva-se para ser notificado no início de cada rodada. Você pode configurar as notificações de transmissões nas suas preferências.';
  ...
  @override
  String get broadcastSinceHideResults => 'A opção de esconder os resultados deixa todas as prévias de partidas vazias para evitar spoilers.';
  ...
  @override
  String get challengeInviteChessigmaUser => 'Ou convide um usuário Chessigma:';

  @override
  String get contactContact => 'Contato';

  @override
  String get contactContactChessigma => 'Entrar em contato com Chessigma';
  ...
  @override
  String get coordinatesKnowingTheChessBoard => 'Saber as coordenadas do tabuleiro é habilidade enxadrística muito importante:';

  @override
  String get coordinatesMostChessCourses => 'A maioria dos cursos e exercícios de xadrez utilizam a notação algébrica extensivamente.';

  @override
  String get coordinatesTalkToYourChessFriends => 'Isso torna mais fácil conversar com seus amigos de xadrez, desde que ambos entendam a \"linguagem do xadrez\".';

  @override
  String get coordinatesYouCanAnalyseAGameMoreEffectively => 'Você pode analisar um jogo mais eficientemente se não precisar ficar procurando os nomes das casas.';

  @override
  String get coordinatesACoordinateAppears => 'Uma coordenada aparece no tabuleiro e você deve clicar na casa correspondente.';

  @override
  String get coordinatesASquareIsHighlightedExplanation => 'Uma casa é destacada no tabuleiro e você deve inserir sua coordenada (ex: \"e4\").';

  @override
  String get coordinatesYouHaveThirtySeconds => 'Você tem 30 segundos para localizar corretamente o máximo de casas possível!';
  ...
  @override
  String get patronChessigmaPatron => 'Apoie o Chessigma';

  @override
  String get patronBecomePatron => 'Seja um Patrono Chessigma';
  ...
  @override
  String get preferencesNotifyBell => 'Notificação no Chessigma';

  @override
  String get preferencesNotifyPush => 'Notificação no dispositivo fora do Chessigma';
  ...
  @override
  String get puzzleFromMyGamesNone => 'Você não tem nenhum problema no banco de dados, mas o Chessigma ainda te ama muito.\n\nJogue partidas rápidas e clássicas para aumentar suas chances de ter um problema seu adicionado!';
  ...
  @override
  String get puzzleThemeVukovicMateDescription => 'Uma torre e um cavalo colocam o rei em xeque. A torre dá xeque-mate protegida por outra peça, e o cavalo bloqueia as casas de fuga do rei.';
  ...
  @override
  String get puzzleThemeMixDescription => 'Um pouco de tudo. Você nunca sabe o que vai encontrar, então esteja pronto para tudo! Igualzinho aos jogos em tabuleiros reais.';
  ...
  @override
  String get challengeAFriend => 'Desafie um amigo';
  ...
  @override
  String get createTheGame => 'Criar uma partida';
  ...
  @override
  String get copyMainLinePgn => 'Copiar PGN da linha principal';
  ...
  @override
  String get dtzWithRounding => 'DTZ50\" com arredondamento, baseado no número de lances até a próxima captura ou movimento de peão';
  ...
  @override
  String get undefendedPieces => 'Peças indefesas';

  @override
  String get pinnedPieces => 'Peças cravadas';

  @override
  String get checkableKing => 'Rei possível de xeque';
  ...
  @override
  String get variantsDescription => 'Mais formas de jogar';
  ...
  @override
  String get blankedPassword => 'Você usou a mesma senha em outro site, e esse site foi comprometido. Para garantir a segurança da sua conta no Chessigma, você precisa criar uma nova senha. Agradecemos sua compreensão.';

  @override
  String get youAreLeavingChessigma => 'Você está saindo do Chessigma';

  @override
  String get neverTypeYourPassword => 'Nunca digite sua senha do Chessigma em outro site!';
  ...
  @override
  String get unlimitedDescription => 'Leve o tempo que precisar';
  ...
  @override
  String get whiteProposesTakeback => 'Brancas propõem voltar jogada';

  @override
  String get blackProposesTakeback => 'Pretas propõem voltar jogada';

  @override
  String get takebackPropositionSent => 'Proposta de voltar jogada enviada';

  @override
  String get whiteDeclinesTakeback => 'Brancas recusam voltar jogada';

  @override
  String get blackDeclinesTakeback => 'Pretas recusam voltar jogada';

  @override
  String get whiteAcceptsTakeback => 'Brancas aceitam voltar jogada';

  @override
  String get blackAcceptsTakeback => 'Pretas aceitam voltar jogada';

  @override
  String get whiteCancelsTakeback => 'Brancas cancelam voltar jogada';

  @override
  String get blackCancelsTakeback => 'Pretas cancelam voltar jogada';
  ...
  @override
  String get previouslyOnChessigmaTV => 'Anteriormente em Chessigma TV';
  ...
  @override
  String get reportCheatBoostHelp => 'Cole o link do(s) jogo(s) e explique o que há de errado com o comportamento do usuário. Não diga apenas \"ele trapaceia\", informe-nos como chegou a esta conclusão.';
  ...
  @override
  String get ifYouDoNotGetTheEmail => 'Se não receber o e-mail dentro de 5 minutos:';

  @override
  String get checkAllEmailFolders => 'Verifique o lixo, o spam e outras pastas';

  @override
  String verifyYourAddress(String param) {
    return 'Confirme se $param é seu endereço de e-mail';
  }
  ...
  @override
  String get networkLagBetweenYouAndChessigma => 'Atraso na rede';
  ...
  @override
  String get downloadAllGames => 'Baixar todas as partidas';
  ...
  @override
  String get showUnreadChessigmaMessage => 'Você recebeu uma mensagem privada do Chessigma.';
  ...
  @override
  String get agreementPolicy => 'Eu concordo que seguirei todas as normas do Chessigma.';
  ...
  @override
  String get lostAgainstTOSViolator => 'Você perdeu rating para alguém que violou os termos de serviço do Chessigma';
  ...
  @override
  String get reopenYourAccountDescription => 'Caso tenha encerrado a conta, mas mudou de ideia, você tem a chance de recuperá-la.';
  ...
  @override
  String get lichessDbExplanation => 'Amostra de partidas rankeadas de todos os jogadores do Chessigma';
  ...
  @override
  String get lichessPatronInfo => 'Chessigma é um software de código aberto, totalmente grátis e sem fins lucrativos. Todos os custos operacionais, de desenvolvimento, e os conteúdos são financiados unicamente através de doações de usuários.';
  ...
  @override
  String get enableBlindMode => 'Habilitar modo às cegas';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'O seu adversário deixou a partida. Você pode reivindicar vitória em $count segundos.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerChessigmaStreamers => 'Streamers do Chessigma';
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Por favor, convide apenas pessoas que você conhece e que queiram participar efetivamente deste estudo.';
  ...
  @override
  String get studyTheChapterIsTooShortToBeAnalysed => 'O capítulo é muito curto para ser analisado.';

  @override
  String get studyOnlyContributorsCanRequestAnalysis => 'Apenas os colaboradores de um estudo podem solicitar uma análise de computador.';

  @override
  String get studyGetAFullComputerAnalysis => 'Obter uma análise completa dos movimentos pelo servidor.';

  @override
  String get studyMakeSureTheChapterIsComplete => 'Certifique-se de que o capítulo está completo. Você só pode solicitar análise uma vez.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition => 'Todos os membros em SYNC veem a mesma posição';

  @override
  String get studyShareChanges => 'Compartilhar as alterações com os espectadores e salvá-las no servidor';
  ...
  @override
  String get studyCopyRawChapterPgn => 'Copiar PGN sem formatação';
  ...
  @override
  String get studyOnlyPublicStudiesCanBeEmbedded => 'Apenas os estudos públicos podem ser incorporados!';
  ...
  @override
  String get studyClearAllCommentsInThisChapter => 'Remover todos os comentários e formas deste capítulo?';
  ...
  @override
  String get studyDeleteTheStudyChatHistory => 'Excluir o histórico de conversação do estudo? Não há volta!';
  ...
  @override
  String get studyGetTheTour => 'Perdido(a)? Faça o tour!';

  @override
  String get studyWelcomeToChessigmaStudyTitle => 'Bem-vindo(a) aos Estudos do Chessigma!';

  @override
  String get studyWelcomeToChessigmaStudyText => 'Este é um tabuleiro de análise compartilhado.<br><br>Use para analisar jogos,<br>discutir posições com amigos<br>e, claro, ter aulas de xadrez!<br><br>Vejamos como usar esse poderoso recurso.';

  @override
  String get studySharedAndSaveTitle => 'Compartilhado e salvo';

  @override
  String get studySharedAndSavedText => 'Outros membros podem ver suas jogadas em tempo real!<br>E tudo fica salvo para sempre.';
  ...
  @override
  String studyStudyMembersText(String param1, String param2) {
    return '$param1 Espectadores podem ver o estudo e conversar.<br><br>$param2 Colaboradores podem mover peças e atualizar o estudo.';
  }

  @override
  String studyAddMembersText(String param) {
    return 'Clique no botão $param.<br>Decida quem pode colaborar ou não.';
  }

  @override
  String get studyStudyChaptersTitle => 'Capítulos';

  @override
  String get studyStudyChaptersText => 'Um estudo pode ter vários capítulos.<br>Cada um tem sua posição inicial e suas jogadas próprias.';

  @override
  String get studyCommentPositionTitle => 'Comentar uma posição';

  @override
  String studyCommentPositionText(String param) {
    return 'Clique com o botão direito na lista de jogadas, ou no botão $param.<br>Os comentários são compartilhados e salvos.';
  }

  @override
  String get studyAnnotatePositionTitle => 'Fazer anotações';

  @override
  String get studyAnnotatePositionText => 'Clique com o botão direito na lista de jogadas, ou no botão !?.<br>As anotações são compartilhadas e salvas.';

  @override
  String get studyConclusionTitle => 'Agradecemos seu tempo';

  @override
  String get studyConclusionText => 'Você pode ver seus <a href=\'/study/mine/hot\'>estudos antigos</a> no seu perfil.<br>Há também um <a href=\'//lichess.org/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way\'>post sobre os estudos</a>.<br>Usuários avançados podem apertar \"?\" para ver atalhos de teclado.<br>Divirta-se!';

  @override
  String get studyCreateChapterTitle => 'Vamos criar um capítulo';

  @override
  String get studyCreateChapterText => 'Um estudo pode ter vários capítulos.<br>Cada um tem uma árvore de jogadas<br>e pode ser criado de muitas formas.';

  @override
  String get studyFromInitialPositionTitle => 'A partir da posição inicial';

  @override
  String get studyFromInitialPositionText => 'Uma configuração para partidas novas.<br>Boa para estudar aberturas.';
  ...
  @override
  String get studyLoadExistingChessigmaGameTitle => 'Carregar um jogo de lichess existente';

  @override
  String get studyLoadExistingChessigmaGameText => 'Cole a URL de um jogo<br>(como lichess.org/7fHIU0XI)<br>para inserir as jogadas no capítulo.';

  @override
  String get studyFromFenStringTitle => 'De uma sequência FEN';

  @override
  String get studyFromFenStringText => 'Cole uma posição FEN<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>para iniciar o capítulo a partir dela.';

  @override
  String get studyFromPgnGameTitle => 'A partir de um jogo PGN';

  @override
  String get studyFromPgnGameText => 'Cole um jogo em formato PGN<br>para inserir jogadas, comentários e variantes no capítulo.';

  @override
  String get studyVariantsAreSupportedTitle => 'Os estudos suportam variantes';

  @override
  String get studyVariantsAreSupportedText => 'Sim, você pode estudar Crazyhouse<br>e qualquer outra variante!';

  @override
  String get studyChapterConclusionText => 'Capítulos ficam salvos para sempre.<br>Divirta-se organizando o conteúdo!';
