...
class AppLocalizationsRo extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Aceste preferințe sunt aplicate contului dvs. Chessigma și vor fi utilizate pe toate dispozitivele.';
  ...
  String get broadcastSourceUrlHelp =>
      'URL-ul pe care Chessigma îl va verifica pentru a obține actualizări al PGN-ului. Trebuie să fie public accesibil pe Internet.';

  @override
  String get broadcastSourceGameIds =>
      'Până la 64 de ID-uri de joc Chessigma, separate prin spații.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Un link permanent pentru oricine să vă provoace cu aceste setări exacte.';
  ...
  String get blankedPassword =>
      'Ați folosit aceeași parolă pe un alt site, iar acel site a fost compromis. Pentru a asigura siguranța contului dvs. Chessigma, trebuie să setați o parolă nouă. Vă mulțumim pentru înțelegere.';
  ...
  String get thisAccountViolatedTos =>
      'Acest cont a încălcat condițiile de utilizare ale site-ului Chessigma';
  ...
  String get timeToProcessAMoveOnChessigmaServer =>
      'Timpul necesar procesării unei mutări pe serverul Chessigma';
  ...
  String get lostAgainstTOSViolator =>
      'Ai pierdut în fața cuiva care a încălcat Termenii și Condițiile Chessigma';
  ...
  String get studyLoadExistingChessigmaGameText =>
      'Lipește un URL pentru joc din Chessigma<br>(de exemplu lichess.org/7fHIU0XI)<br>pentru a încărca mutările jocului în capitol.';
  ...
  String get studyVariantsAreSupportedText =>
      'Da, poți studia Crazyhouse<br>și toate variantele de șah de pe Chessigma!';
