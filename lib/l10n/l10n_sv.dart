...
class AppLocalizationsSv extends AppLocalizations {
  ...
  String get broadcastSourceUrlHelp =>
      'URL som Chessigma kan använda för att få PGN-uppdateringar. Den måste vara publikt tillgänglig från Internet.';

  @override
  String get broadcastSourceGameIds =>
      'Upp till 64 Chessigma-partiers ID, separerade med mellanslag.';
  ...
  String get blankedPassword =>
      'Du har använt samma lösenord på en annan hemsida, och den hemsidan har blivit hackad. För att säkra ditt Chessigmakonto måste du välja ett nytt lösenord. Tack för din förståelse.';
  ...
  String get studyVariantsAreSupportedText =>
      'Ja, du kan studera crazyhouse<br>och alla varianter som finns på Chessigma!';
