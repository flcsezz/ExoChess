...
enum BroadcastResult {
  ...
  Color? colorFor(Side side, BuildContext context) => switch (this) {
    whiteWins => side == Side.white ? Theme.of(context).colorScheme.secondary : Theme.of(context).colorScheme.error,
    blackWins => side == Side.white ? Theme.of(context).colorScheme.error : Theme.of(context).colorScheme.secondary,
    _ => null,
  };
}
...
enum BroadcastFideTC {
  ...
  IconData get icon => switch (this) {
    BroadcastFideTC.standard => ExoChessIcons.classical,
    BroadcastFideTC.rapid => ExoChessIcons.rapid,
    BroadcastFideTC.blitz => ExoChessIcons.blitz,
  };
