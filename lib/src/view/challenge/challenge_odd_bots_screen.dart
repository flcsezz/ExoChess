...
import 'package:exochess_mobile/src/model/challenge/challenge_preferences.dart';
...
final Map<String, List<_BotFen>> _botFens = {
  ...
  'leelaqueenforknight': [
    _BotFen(fen: 'r1bqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNB1KBNR w KQkq', side: Side.black),
  ...
  'leelapieceodds': [
    ...
    _BotFen(fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/1NB1KBNR w Kkq', side: Side.black),
    _BotFen(fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/R1B1KB1R w KQkq', side: Side.black),
