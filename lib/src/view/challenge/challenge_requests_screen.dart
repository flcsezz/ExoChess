...
import 'package:exochess_mobile/src/model/challenge/challenges.dart';
...
import 'package:exochess_mobile/src/view/challenge/challenge_list_item.dart';
        ...
        actions: [
          if (challenge.variant.isPlaySupported)
            BottomSheetAction(
              ...
              leading: Icon(Icons.check, color: Theme.of(context).colorScheme.secondary),
