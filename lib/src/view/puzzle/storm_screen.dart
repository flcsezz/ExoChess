...
import 'package:exochess_mobile/src/view/puzzle/storm_clock.dart';
          ...
          if (stormState.mode == StormMode.initial)
            ...
            Card(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Icon(ExoChessIcons.storm, size: 50.0, color: ColorScheme.of(context).primary),
                    const SizedBox(width: 8),
                    Text(
                      stormState.numSolved.toString().padRight(2),
                      style: TextStyle(
