  ...
  actions: [
    BottomSheetAction(
      ...
      onPressed: () {
        launchShareDialog(
          context,
          ShareParams(uri: Uri.parse('https://lichess.org' + '/broadcast/${broadcastData.slug}/${broadcastData.id}')),
        );
      },
    ),
    BottomSheetAction(
      ...
      onPressed: () {
        launchShareDialog(
          context,
          ShareParams(
            uri: Uri.parse('https://lichess.org' + '/broadcast/${broadcastData.slug}/${round.slug}/${round.id}'),
          ),
        );
      },
    ),
    BottomSheetAction(
      ...
      onPressed: () {
        launchShareDialog(
          context,
          ShareParams(
            uri: Uri.parse('https://lichess.org' + '/broadcast/${broadcastData.slug}/${round.slug}/${round.id}.pgn'),
          ),
        );
      },
    ),
