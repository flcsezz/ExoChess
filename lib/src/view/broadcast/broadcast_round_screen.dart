...
import 'package:exochess_mobile/src/model/broadcast/broadcast.dart';
import 'package:exochess_mobile/src/model/broadcast/broadcast_preferences.dart';
import 'package:exochess_mobile/src/model/broadcast/broadcast_providers.dart';
import 'package:exochess_mobile/src/model/broadcast/broadcast_round_controller.dart';
...
import 'package:exochess_mobile/src/view/broadcast/broadcast_boards_tab.dart';
import 'package:exochess_mobile/src/view/broadcast/broadcast_overview_tab.dart';
import 'package:exochess_mobile/src/view/broadcast/broadcast_players_tab.dart';
import 'package:exochess_mobile/src/view/broadcast/broadcast_share_menu.dart';
import 'package:exochess_mobile/src/view/broadcast/broadcast_teams_tab.dart';
          ...
          child: Row(
            ...
            children: [
              ...
              switch (tournament.rounds.firstWhere((round) => round.id == roundId).status) {
                RoundStatus.finished => Icon(Icons.check, color: Theme.of(context).colorScheme.secondary),
                RoundStatus.live => Icon(Icons.circle, color: Theme.of(context).colorScheme.error),
