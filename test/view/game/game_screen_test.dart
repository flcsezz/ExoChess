...
import 'package:exochess_mobile/src/model/game/game_socket_events.dart';
...
void main() {
  ...
  group('Tournament Game', () {
    ...
    testWidgets('supports berserking', (WidgetTester tester) async {
      ...
      expect(find.byIcon(ExoChessIcons.body_cut), findsOneWidget);

      // we berserk
      await tester.tap(find.byIcon(ExoChessIcons.body_cut));
      await tester.pump(const Duration(milliseconds: 10));
      ...
      expect(find.byIcon(ExoChessIcons.body_cut), findsNWidgets(2));
      ...
      expect(find.byIcon(ExoChessIcons.body_cut), findsNWidgets(3));
    });
  });
  ...
  group('Opening analysis', () {
    ...
    testWidgets('for an unfinished correspondence game', (WidgetTester tester) async {
      ...
      final app = await makeTestProviderScopeApp(
        ...
        overrides: {
          lichessClientProvider: lichessClientProvider.overrideWith(
            (ref) => ExoChessClient(mockClient, ref),
          ),
        },
      );
      await tester.pumpWidget(app);
